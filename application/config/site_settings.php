...
// Website Directory Configurations
$config['beta']						= 1;
$config['website_directory'] 		= 'Site-v7';
$config['website_version'] 			= 'v1.3';

// Management - Dashboard Configurations
$config['managementActionItems']    = 'col-xxl-2 col-lg-4 pb-4';
$config['googleRecaptchaSiteKey']   = '6Ldp1hYhAAAAAB2X7CIwCZsXMjlRKg57bybEIaXX';
$config['googleRecaptchaSecretKey'] = '6Ldp1hYhAAAAADlbKn7gwHadTJKfOrN2CXkc-0BL';
...
// Social Media Links            
$config['facebook_page']            = 'https://www.facebook.com/MyMillennialInvestments';
$config['twitter']                  = 'https://www.twitter.com/MyMillennialPro';
$config['stocktwits']               = 'https://www.stocktwits.com/';
$config['discord']                  = 'https://www.discord.com/';
