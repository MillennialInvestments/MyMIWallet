...
$initial_value				= $coinPurchaseForm['current_value'];		// Define Initial Value of Coin Market Cap
...
$amount						= $coinPurchaseForm['amount'];				// Define Amount of Funds Used to Purchase Coins
...
$user_trans_fees			= 0.6;										// Define User Single Transaction Fee Total
...
$user 						= array(
    ...
    'user_trans_fee'		=> $user_trans_fees,
