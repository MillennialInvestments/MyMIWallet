...
>>>>>>> 76bba32f875dbfd8e00d213db849802fb5378283
    ...
    public function get_chart_orders($status, $market_pair, $market)
    {
        $this->db->select('initial_coin_value');
        $this->db->from('bf_exchanges_orders');
    ...
    public function get_market_closed_orders($status, $market_pair, $market)
    {
