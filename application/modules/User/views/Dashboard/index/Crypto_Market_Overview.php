...
// Reference https://github.com/codenix-sv/bittrex-api for coding;
		...
		<div class="tranx-col">
			<div class="tranx-info">
				<div class="tranx-data">
					<div class="tranx-label">Crypto Markets</div>
	...
	<div class="tranx-item">
		<div class="tranx-col">
			<div class="tranx-info">
				<div class="tranx-data">
					<div class="tranx-label">Bitcoin (BTC)</div>
	...
	<div class="tranx-item">
		<div class="tranx-col">
			<div class="tranx-info">
				<div class="tranx-data">
					<div class="tranx-label">Ethereum (ETH)</div>
	...
	<div class="tranx-item">
		<div class="tranx-col">
			<div class="tranx-info">
				<div class="tranx-data">
					<div class="tranx-label">Cardano (ADA)</div>
	...
	<div class="tranx-item">
		<div class="tranx-col">
			<div class="tranx-info">
				<div class="tranx-data">
					<div class="tranx-label">XRP (XRP)</div>
    ...
    if ($this->uri->segment(1) === 'Dashboard') {
        $marketURL                              = 'Markets/Crypto-Markets';
        echo '
	<div class="tranx-item">
