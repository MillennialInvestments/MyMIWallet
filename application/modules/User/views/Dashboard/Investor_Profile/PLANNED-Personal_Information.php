    ...
    <div class="nk-data data-list">
        ...
        <script>
            function email_Switch(e) {
                ...
                element.innerHTML       = `
                    <span class="data-label w-25">Email</span>
                    <form class="data-value w-100" id="editPersonalInfo">
                        ...
                        <div class="<?php echo $formGroup; ?>">
                            ...
                            <input class="<?php echo $formControl; ?>" name="${input}" id="${input}" value='${txt}' />
        ...
        <div class="data-item">
            <div class="data-col" id="col_display_name">
                ...
                <span class="data-value w-100" id="display_name"><?php echo $cuDisplayName; ?></span>
                ...
                element.innerHTML       = `
                    ...
                    <form class="data-value w-100" id="editPersonalInfo">
                        ...
                        <div class="<?php echo $formGroup; ?>">
                            ...
                            <input class="<?php echo $formControl; ?>" name="${input}" id="${input}" value='${txt}' />
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="submit" name="register" id="submitUserInfo"><i class="icon ni ni-check-circle"></i></button
