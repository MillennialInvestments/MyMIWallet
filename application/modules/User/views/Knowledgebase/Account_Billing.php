    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            <div class="content-page">
                            ...
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">   
                                                For the most part, you can easily edit your personal account information via your <a href="<?php echo site_url('Investor-Profile'); ?>">Investor Profile</a>. 
                                                ...
                                                All requests for information will be provided with notification via email (<a href="mailto:support@mymiwallet.com">support@mymiwallet.com</a>) and completed within the MyMI Wallet Dashboard. 
                                                Any documentation requested from any other communication could be potential for fraud and spam. Please disregard if this were ever to be the case.                             
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <?php $this->load->view('User/Knowledgebase/includes/Partnerships/subheader'); ?>
                <?php $this->load->view('User/Knowledgebase/includes/Partnerships/full_content'); ?>
                <?php $this->load->view('User/Knowledgebase/includes/Partnerships/more_details'); ?>
                            ...
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">   
                                                To provide our Investors and Partnerships with a seamless way to make purchases and even sell assets on our Marketplace and Exchange, we developed an In-App Coin to process those transactions. 
                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">   
                                                ...
                                                MyMI Gold is currently sold in packages designed to ensure all members could access the tools they require. 
                                            </p>
                                            <p class="lead fs-14px">   
                            ...
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">        
                                                Premium Features are purchased on a <strong>Month-to-Month Basis</strong> (a recurring cost) and what our members are required to pay every month is determined by the Premium Features activated on their account, 
                                                along with the Total Number of each Premium Feature(s) the member has purchased.                   
                                            </p>
                                            <p class="lead fs-14px">        
                                                Invoicing for all Premium Features is conducted on the <strong>14th of every month</strong> and automatic payments are set up to obtain funds to cover the cost of those Premium Features on the <strong>15th of every month</strong>. 
                                                ...
                                                If the user doesn't have enough to cover the cost of their Monthly Recurring Premium Feature Costs, the member will be notified to purchase additional MyMI Gold to cover that expense.                   
                                            </p>
                                        </div>
                                    </div>
                                </div>
