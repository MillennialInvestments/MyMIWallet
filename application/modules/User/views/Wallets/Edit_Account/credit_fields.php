...
<div class="<?php echo $formGroup; ?> mb-2">
        <label for="credit_status" class="col-12">Credit Card Status</label>
        <div class="col-12">
...
<div class="<?php echo $formGroup; ?>">
	...
	<div class="col-12">        
		<input type="text" class="<?php echo $formControl; ?>" name="credit_limit" id="credit_limit" onChange="calculateBalance(); return false;"  placeholder="Ex: 1500.00" value="<?php echo set_value('credit_limit', isset($user) ? $user->credit_limit : $accountLimit); ?>">	
	</div>
</div>
<div class="<?php echo $formGroup; ?>">
