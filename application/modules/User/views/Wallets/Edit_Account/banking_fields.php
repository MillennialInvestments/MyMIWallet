...
<div class="<?php echo $formGroup; ?>">
    <label class="col-12">Credit Card Status</label>
    <div class="col-12">    
...
<div class="<?php echo $formGroup; ?>">
	...
	<div class="col-12">        
		<input type="text" class="<?php echo $formControl; ?> calculation" name="balance" id="balance" onChange="calculateExpression(this); return false;" placeholder="Ex: 1500.00" value="<?php echo set_value('balance', isset($user) ? $user->balance : $accountBalance); ?>">	
	</div>
</div>
