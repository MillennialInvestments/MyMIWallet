...
<div class="<?php echo $formGroup; ?> mb-2">    
	<label for="broker" class="col-12">Broker/Exchange</label>
	<div class="col-12">
        <select class="<?php echo $formSelectPicker; ?>" data-live-search="true" id="broker" name="broker" required style="height:40px;padding:10px">
            <?php
                if ($walletType === 'Fiat') {
                    $broker_values = array(
...
<div class="<?php echo $formGroup; ?>">    
	<label class="col-12" for="default-01">Wallet Nickname <span class="text-muted">(Optional)</span></label>    
	<div class="col-12">       
...
<div class="<?php echo $formGroup; ?>">    
	<label class="col-12" for="default-01">Current Account Balance</label>    
	<div class="col-12">       
		<input type="text" class="<?php echo $formControl; ?> calculation" onChange="calculateExpression(this); return false;" name="amount" id="amount" placeholder="Enter Current Value of Wallet" value="<?php echo set_value('amount', isset($user) ? $user->amount : 0); ?>">	
	</div>
</div>
