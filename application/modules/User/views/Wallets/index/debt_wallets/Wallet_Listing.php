		...
		<div class="nk-wgw">
			...
			<div class="nk-wgw-actions">
                <ul class="vertical-divider">
					...
					<li class="' . $btnSizing . '">
                        <a href="' . site_url('Wallets/Debt/Edit/Account/' . $accountID) . '"><i class="icon ni ni-pen2 mr-1"></i> <span>Edit</span></a>
					</li>
					<li class="' . $btnSizing . '">
			...
			<div class="nk-wgw-more dropdown">
				...
				<div class="dropdown-menu dropdown-menu-xs dropdown-menu-right">
					<ul class="link-list-plain sm">
						<li><a href="' . site_url('/Budget/Details/' . $accountID) . '">Details</a></li>   
						<li><a href="' . site_url('/Budget/Edit/' . $walletID) . '">Edit</a></li>
						<li><a href="' . site_url('/Budget/Delete-Account/' . $walletID) . '" >Delete</a></li>
					</ul>
				</div>
			</div>
		</div>
