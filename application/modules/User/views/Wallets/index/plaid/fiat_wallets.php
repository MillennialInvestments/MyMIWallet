<div class="nk-block nk-block-lg">
	<div class="nk-block-head-sm">
		<div class="nk-block-head-content"><h5 class="nk-block-title title">Fiat Accounts</h5></div>
	</div>
</div>
<div class="row">
<?php
    ...
    $this->load->view('User/Wallets/index/fiat_wallets/MyMIWallet', $MyMIWalletData);
