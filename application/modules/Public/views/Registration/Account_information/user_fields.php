...
<div class="row">
	<div class="col-12 col-md-3">
		<div class="<?php e($controlGroup); ?> <?php echo form_error('first_name') ? $errorClass : ''; ?>">
			<label class="<?php e($controlLabel); ?>" for="first_name">First Name</label>
			<div class="<?php e($controlClass); ?>">
				<input class="<?php echo $controlInput; ?> required" type="text" id="first_name" name="first_name" value="<?php echo set_value('first_name', isset($user) ? $user->first_name : ''); ?>" />
	...
	<div class="col-12 col-md-3">
		<div class="<?php e($controlGroup); ?> <?php echo form_error('last_name') ? $errorClass : ''; ?>">
			<label class="<?php e($controlLabel); ?> required" for="last_name">Last Name</label>
			<div class="<?php e($controlClass); ?>">
	...
	<div class="col-12 col-md-3">
		<div class="<?php e($controlGroup); ?> <?php echo form_error('name_suffix') ? $errorClass : ''; ?>">
			<label class="<?php e($controlLabel); ?>" for="name_suffix">Suffix</label>
			<div class="<?php e($controlClass); ?> ">
...
<input class="<?php e($controlInput); ?>" type="hidden" id="referral_code" name="referral_code" value="<?php echo set_value('referral_code', isset($user) ? $user->referral_code : $pageURIC); ?>" />
