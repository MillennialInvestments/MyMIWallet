 ...
 */
class Analysis extends Front_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->helper(array('address', 'directory', 'form', 'file', 'url'));
        $this->load->library(array('form_validation', 'upload', 'users/auth'));
        $this->load->model(array('CFA/advisor_model', 'users/user_model', 'User/stock_model', 'User/diligence_model'));
    ...
    {
        $pageType = 'Automated';
        $pageName = 'CFA_Analysis_Application';
        $this->load->library('users/auth');
        $this->set_current_user();
        // $this->output->cache(1);
    ...
    public function Application_Manager()
    {
        ...
        Template::set('pageType', $pageType);
        Template::set('pageName', $pageName);
        Template::set_view('CFA/Analysis/Application/Application_Manager');
        Template::render();
    }
