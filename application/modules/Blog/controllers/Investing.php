 ...
 */
class Investing extends Front_Controller
{
    ...
    public function The_Beginners_Guide_To_Option_Trading()
    {
        $pageType = 'Automated';
        $pageName = 'Home';
    ...
    public function The_Fundamentals_Of_Investing()
    {
        $pageType = 'Automated';
        $pageName = 'Home';
    ...
    public function Tips_For_Effective_Investment_Portfolio_Management()
    {
        $pageType = 'Automated';
        $pageName = 'Home';
