...
class Budgeting extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('API/api_model', 'User/exchange_model', 'User/mymigold_model', 'User/tracker_model', 'Management/announcements_model', 'Management/budgeting_model', 'Management/design_model'));
    ...
    {
        if ($this->budgeting_model->debt_collector_cleanup()) {
            Template::set_message('Recurring Account updated to \'is_debt\' = 1.', 'success');
            Template::redirect('/Management'); 
        } else {
