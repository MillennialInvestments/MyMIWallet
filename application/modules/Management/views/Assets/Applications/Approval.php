        ...
        <div class="col-lg-12 col-xl-12">
            ...
            <div class="nk-block">
                <div class="row">
                    ...
                    ';
                    $this->load->view('Management/Assets/Applications/Details/Approval_Tasks', $userData); 
                    echo '
                    </div><!-- .col -->
                            ...
                            <div class="card-inner p-3">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tabItem2">';
                                        $this->load->view('Management/Assets/Applications/Approval/Market_Conversion', $userData);
                                    echo '
                                    </div>
