		...
		<div class="col-lg-12 col-xl-12">
			...
			<div class="nk-block">
                <div class="row">
                    <!-- Action Center -->
                    <div class="col-lg-4">
                        <?php $this->load->view('Management/Marketing/Tasks/action_center', $viewFileData); ?>
                    </div><!-- .col -->
                    <!-- Month-to-Month Overview -->
                    <div class="col-lg-8">
                        <?php $this->load->view('Management/Marketing/Tasks/monthly_overview', $viewFileData); ?>
                    </div>
                </div>
			</div>
            <div class="nk-block">
                <div class="row">
                    <div class="col-lg-12">
                        <?php $this->load->view('Management/Marketing/Tasks/Listing-Table', $viewFileData); ?>
                    </div>
                </div>
            </div>
		</div>
