		...
		<div class="col-lg-12 col-xl-12">
			...
			<div class="nk-block">
                <div class="row">
                    <!-- Action Center -->
                    <div class="col-lg-4">
                        <?php $this->load->view('Management/Services/index/action_center', $viewFileData); ?>
                    </div><!-- .col -->
                    <!-- Month-to-Month Overview -->
                    <div class="col-lg-8">
                        <?php $this->load->view('Management/Services/index/monthly_overview', $viewFileData); ?>
                    </div>
                </div>
			</div>
            <div class="nk-block">
            ...
            <div class="nk-block">
                <div class="row g-gs">
                    <?php //$this->load->view('Management/Services/index/operational_tasks', $viewFileData); ?>
                </div>
            </div>
            <div class="nk-block">
                <div class="row">
                    <div class="col-lg-12">
                        <?php //$this->load->view('Management/Services/Campaigns/Listing-Table', $viewFileData); ?>
                    </div>
                </div>
            </div>
		</div>
