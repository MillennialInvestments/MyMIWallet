...
$current_value							= $orderForm['initial_value'] + $orderForm['buy_amount'];
...
if ($getOppTradeInfo !== null) {
    ...
    $orderData 							= array(
        ...
        'amount'					 	=> $orderForm['buy_amount'],
        'total'						 	=> $total,
        'remaining_coins'				=> $remaining_coins,
        'gas_fee'					 	=> $orderForm['buy_gas_fee'],
        'user_gas_fee'					=> $orderForm['buy_user_gas_fee'],
        'trans_percent'				 	=> $orderForm['buy_trans_percent'],
        'user_trans_percent'			=> $orderForm['buy_user_trans_percent'],
        'trans_fee'						=> $orderForm['buy_trans_fee'],
        'user_trans_fees'				=> $orderForm['buy_user_trans_fee'],
        'fees'						 	=> $orderForm['buy_fees'],
        'total_cost'					=> $orderForm['buy_total_cost'],
    ...
    $orderTradeData						= array(
        ...
        'company'						=> $market_pair . '-' . $market,
        'link'							=> 'Exchange/Market/' . $market_pair . '/' . $market,
        'total_trade_cost'				=> $orderForm['buy_total_cost'],
        'current_price'					=> $orderForm['buy_amount'],
        'position_size'					=> $total,
    );
