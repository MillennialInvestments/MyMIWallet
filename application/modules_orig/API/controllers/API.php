...
class API extends Front_Controller
{
    ...
    public function Purchase_Coins_Transaction()
    {
        ...
        $this->load->view('API/Purchase_Coins_Transaction');
    }

    public function Ticker_Price_Server()
    {
        $this->load->library('users/auth');
        $this->set_current_user();
        
        $this->load->view('API/Ticker_Price_Server');
    }

    public function Ticker_Price_Manager()
    {
        $this->load->library('users/auth');
        $this->set_current_user();
        
        $this->load->view('API/Ticker_Price_Manager');
    }
