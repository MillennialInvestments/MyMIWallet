...
<div class="intro-banner bg-dark pb-5">
    <div class="container">
        <div class="row justify-content-center">
                ...
                <div class="intro-banner-wrap">
                    <div class="intro-banner-inner text-center">
                        <div class="intro-banner-desc pt-0">
                            <span class="overline-title myfs-md pt-5">Introducing</span>
                            <h1 class="title text-white">Our Story</h1>
                            <!-- <h2 class="subttitle text-white pb-5">Why All The Fuss?</h1> -->
                            <p class="text-light">
                                A powerful Investment Accounting/Analytical Software and Crypto Asset Marketplace & Exchange for Retail & Institutional Investors alike. 
...
<div class="intro-section intro-overview text-center bg-white pt-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="intro-section-title">
                    ...
                    <h2 class="intro-heading-lead">Where We've Been</h2>
                    <div class="intro-section-desc text-left">
                        <p class="py-3">
                        Since March of 2021, we’ve developing and testing ideas and opportunities to provide the industry with the best financial solutions platform that not only works for your more experienced investors but also investors who are potentially new to the market while also including the ability to provide support for institutions and businesses across the world.
                        </p>
                    </div>
                </div>
               <hr class="my-5">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="intro-section-title">
                    <h2 class="intro-heading-lead">Why We Are Here</h2>
                    <div class="intro-section-desc text-left">
                        <h3>Where It Started For Us</h3>
                        <p class="py-3">
                            Originally, I had generated a large sum of funds for another company that I was a co-owner of and with that, I wanted to discover potential investments that we could conduct to expand our liquidity and assets in hopes of potentially geographically expanding the company while building our stronghold in our operational markets at the time, and so that’s where I introduce myself to actively trading and investing. 
                        </p>
                        <h3>The Investing Tracking System</h3>
                        <p class="py-3">
                            During that timeframe, I felt the need to be able to analyze and decipher “mistakes made”, “how were we making money..” and things of that nature. 
                            With being a developer, my first mindset was to develop an investment tracker to start studying and evaluating specific indicators of what made the difference in performance of a trade. 
                            So my analytical nature went through and I built my first initial trade Tracker. 
                        </p>
                        <h3>Trade Alerts! Trade Alerts! Trade Alerts!</h3>
                        <p class="py-3">
                            With this ability to not only track this information, I also developed a way to share it with my peers who were active in the markets to analyze and discuss amongst ourselves. 
                            This lead me to the idea of sharing this information with everyone else with as much complexity as possible, but in a format that not only more experienced investors/traders could digest, but newcomers to the markets as well. 
                            This gave me the want and need to fill the gap between even the institutional investors and retail investors as far as how information was not away, but provided with the ability to be divulged by everyone.
                        </p>
                        <h3>The Conversation..</h3>
                        <p class="py-3">
                            While toying with the idea during COVID going into 2021, I began testing the flexibility of the platform and the communication space that would be available in order to analyze the outlets we had that were efficient enough to reach out to all other investors, regardless of their experience, preferences of Investing and Trading, as well as regardless of their bank account size. 
                            We experimented with things a new “Financial Social Media Space” because of the growing need for a new space due to the oppressive “Community Standards” where Investment Groups were being completed obliterated due to one member who was most likely a bot account saying something stupid. 
                            We entertained of a potential news delivery system, an API Central Hub for all things financial, a Crypto Exchange and Marketplace, a multitude of things.
                        </p>
                        <h3>The Ultimate Conclusion</h3>
                        <p class="py-3">
                            In our findings, we found each to very extensively dependent upon a management system and/or team, very labor intensive type of considerations. 
                            So our ultimate conclusion came down to the need for automation in most of those management systems. 
                            In our findings, not only was the availability of information key, but the privacy of that information was also just as important. 
                            We also discovered that user-driven data would ultimately suppress the need for a “centralized management or control” per say. 
                            And the first step in assisting anyone is by providing the ability to allow them to assist and understand themselves first and foremost
                        </p>
                        <h3>The Ultimate Decision</h3>
                        <p class="py-3">
                            We decided to move forward by not just picking one of the available avenues previously listed but we determined that incorporating it all would be key in a multitude of ways, but we first had to know each individual accordingly and specific their financial situations and circumstances. 
                            So our first step was to develop what is now our MyMI Budgeting and Trade Tracking System. 
                            By providing these tools, not only could we understand our members more in-depth, but we could provide a way to visualize help them understand themselves. 
                            By giving them the tools they need to take the steps required in improving their financial health, we could construct a more concise method of assisting our members by first discovering and determining the true need of each investor and trader on an individual-use case basis. 
                        </p>
                        <h3>The Future To Come..</h3>
                        <p class="py-3">
                            Now that we have completed the overhaul of our Investor Dashboard, we can begin focusing on what doors can now be opened such as Sharing and Community Building amongst our members, rewards for their efforts in spreading the platform with other investors and traders. 
                            More in-depth insight in what is not only really making a lot of money, but what investment decisions are causing investors and traders to ultimately loss money. 
                            By minimizing the potential to loss, we optimizing our chances of winning. Teach a man to fish
                        </p>
                    </div>
                    <hr class="my-5">
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="intro-section-title">
                    <h2 class="intro-heading-lead">Finally.. How That's Going!</h2>
                    <div class="intro-section-desc">
                        <?php 
                        $this->db->from('bf_development_updates');
                        $this->db->where('status', 1); 
                        $this->db->where('publish', 1); 
                        $getDevUpdates                  = $this->db->get();
                        if (empty($getDevUpdates)) {
                            foreach($getDevUpdates->result_array() as $devUpdate) {
                                echo '          
                                <div class="border border-primary rounded p-5">  
                                    <p class="text-left">
                                        <strong>' . $devUpdate['topic'] . '</strong>
                                        ' . $devUpdate['description'] . ' 
                                    </p>
                                </div>
                                ';
                            }
                            ...
                            <div class="border border-primary rounded p-5">                      
                                <p class="text-center">
                                    <strong>No Developments to Announce</strong>
                                    We currently do not have any recent updates to share, but expected to receive more news soon regarding our next steps into the future.
                                </p>
                            </div>   
                            ';
                        }
                    ...
                    <hr class="my-5">
                    <h2 class="intro-heading-lead">MyMI Statistics</h2>
                </div>  
            </div>  
        </div>  
        <div class="row justify-content-center">
...
<div id="intro-layout" class="intro-section intro-preview bg-white">
...
<div class="intro-section intro-story bg-white">
    <div class="container container-ld">
        <div class="row justify-content-between">
