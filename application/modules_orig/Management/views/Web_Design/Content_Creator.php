...
<div class="nk-block">
	<div class="row gy-gs">
        ...
        <div class="col-12">
            <?php $this->load->view('Management/Web_Design/Content_Creator/Budgeting/Paid_Status_Update'); ?>
            <?php //$this->load->view('Management/Web_Design/Content_Creator/Sophton/JS_Authorization'); ?>
            <?php //$this->load->view('Management/Web_Design/Content_Creator/Sophtron/Sophtron_API_Setup'); ?>
            <?php //$this->load->view('Management/Web_Design/Content_Creator/Sophtron_API_Setup'); ?>
            <?php //$this->load->view('Management/Web_Design/Content_Creator/Plaid/Link_Web'); ?>
            <?php //$this->load->view('Management/Web_Design/Content_Creator/Sophtron_Integration'); ?>
            <?php // $this->load->view('Management/Web_Design/Content_Creator/Sophtron_Setup'); ?>
            <?php //$this->load->view('Management/Web_Design/Content_Creator/Sophtron_Setup'); ?>
            <?php //$this->load->view('Management/Web_Design/Content_Creator/Sophtron_Widget'); ?>
