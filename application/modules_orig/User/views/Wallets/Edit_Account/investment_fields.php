...
// Form Error Configurations & Controls
...
foreach ($walletAccount as $account) { 
    ...
    $accountAccessKey           = $account['access_code'];
    $accountRefreshToken        = $account['refresh_token'];
    $accountBrokerID            = $account['broker_id'];
    $accountBroker              = $account['broker'];
    $accountBalance             = $account['balance'];
    $accountInitialValue        = $account['initial_value'];
    $accountNickname            = $account['nickname']; 
}
?>                              
<h4 class="card-title">Edit Wallet Information</h4>
...
<div class="<?php echo $formGroup; ?> mb-2">    
	...
	<div class="col-6">       
		<input type="text" class="<?php echo $formControl; ?>" name="nickname" id="nickname" placeholder="Enter Account Nickname" value="<?php echo set_value('nickname', isset($user) ? $user->nickname : $accountNickname); ?>">	
	</div>
</div>
<div class="<?php echo $formGroup; ?> mb-2"> 
...
<div class="<?php echo $formGroup; ?> mb-2">    
	...
	<div class="col-6">       
		<input type="text" class="<?php echo $formControl; ?>" name="amount" id="amount" placeholder="Enter Current Value of Wallet" value="<?php echo set_value('amount', isset($user) ? $user->amount : $accountBalance); ?>">	
	</div>
</div>
