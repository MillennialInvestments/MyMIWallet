	...
	<div class="card card-bordered">
		<div class="nk-wgw">
			...
			<div class="nk-wgw-actions">
				<ul>
					<li class="' . $btnSizing . '">
						<a href="' . site_url('Wallets/Credit/Details/' . $accountID) . '"><i class="icon ni ni-list-index"></i> <span>Details</span></a>
					</li>
					<li class="' . $btnSizing . '">
                        <a href="' . site_url('Wallets/Credit/Edit/Account/' . $accountID) . '"><i class="icon ni ni-pen2"></i> <span>Edit</span></a>
					</li>
					<li class="' . $btnSizing . '">
