	...
	<div class="card card-bordered">
		<div class="nk-wgw">
			...
			<div class="nk-wgw-actions">
				<ul>
					<li class="' . $btnSizing . '">
						<a href="' . site_url('Wallets/Banking/Details/' . $accountID) . '"><i class="icon ni ni-list-index"></i> <span>Details</span></a>
					</li>
					<li class="' . $btnSizing . '">
                        <a href="' . site_url('Wallets/Banking/Edit/Account/' . $accountID) . '"><i class="icon ni ni-pen2"></i> <span>Edit</span></a>
					</li>
					<li class="' . $btnSizing . '">
                        <a data-toggle="modal" data-target="#deleteWalletModal" onclick="openModal(event)" data-id="' . $walletID . '"><i class="icon ni ni-cross"></i> <span>Delete</span></a>
					</li>
				</ul>
			</div>
