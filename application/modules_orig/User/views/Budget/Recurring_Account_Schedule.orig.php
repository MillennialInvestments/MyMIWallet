...
$interval                                   = date_diff($desDateTime, $eoyDateTime);
// print_r($interval);
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    foreach($data as $id=>$account) {
                                        $thisCurrentDate                                = $account['initial_weeks_left'];
                                        $thisLastDate                                   = $account['last_date'];
                                        $initialAmount                                  = $account['net_amount']; 
                                        $accountRecSchedule                             = $account['recurring_schedule'];
                                        $desDateTime                                    = DateTime::createFromFormat('m-d-Y', $account['designated_date']);
                                        $accountDate                                    = $desDateTime->format('m-d-Y'); 
                                        $accountMonth                                   = $desDateTime->format('m'); 
                                        $accountDay                                     = $desDateTime->format('d'); 
                                        $accountYear                                    = $desDateTime->format('Y'); 
