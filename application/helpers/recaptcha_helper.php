 ...
 *
 */
defined('RECAPTCHA_SITE_KEY')                 OR define('RECAPTCHA_SITE_KEY', '6Ldp1hYhAAAAAB2X7CIwCZsXMjlRKg57bybEIaXX');
defined('RECAPTCHA_SITE_SECRET')              OR define('RECAPTCHA_SITE_SECRET', '6Ldp1hYhAAAAADlbKn7gwHadTJKfOrN2CXkc-0BL');
