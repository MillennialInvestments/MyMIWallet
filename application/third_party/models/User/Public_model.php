...
class Public_model extends BF_Model
{
    ...
    */
     ...
     */
    public function get_marketing_seo($pageName)
    {
    ...
    public function get_page_seo($pageName)
    {
        $this->db->from('bf_marketing_page_seo');
        $this->db->where('page_name', $pageName);
    ...
    public function get_symbol_header($symbol)
    {
    ...
    public function get_all_wallets_count()
    {
        $this->db->from('bf_users_wallet');
        $getAllWalletsCount		= $this->db->get();
        return $getAllWalletsCount;
    }
    
    public function get_all_trades_count()
    {
        $this->db->from('bf_users_trades');
        $getAllTradesCount		= $this->db->get();
        return $getAllTradesCount;
    }
    
    public function get_all_gold_count()
    {
        $this->db->select_sum('total');
        $this->db->from('bf_users_coin_purchases');
        $getAllGoldCount		= $this->db->get();
        return $getAllGoldCount;
    }
}
