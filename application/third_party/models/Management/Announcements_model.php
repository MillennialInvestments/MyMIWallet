...
class Announcements_model extends BF_Model
{
    ...
    */
    ...
    public function post_announcement($submitted_date, $time, $user_id, $topic, $details, $url_link, $video_link, $announcement)
    {
        $user							= array(
        ...
        return $this->db->insert('bf_users_posts');
    }
    ...
    public function get_external_links()
    {
        ...
        $getExternalSites 				= $this->db->get();
        return $getExternalSites;
    }
}
