...
class Bidding_model extends BF_Model
{
    ...
    public function get_bids_for_auction($auction_id) {
        $query = $this->db->get_where('bids', array('auction_id' => $auction_id));
    ...
    public function get_bids_for_user($user_id) {
        $query = $this->db->get_where('bids', array('user_id' => $user_id));
        return $query->result_array();
    }    
    ...
    public function update_bid($id, $data) {
        $this->db->where('id', $id);
        return $this->db->update('bids', $data);
    }

    // Delete a bid
    public function delete_bid($id) {
        return $this->db->delete('bids', array('id' => $id));
    }     
