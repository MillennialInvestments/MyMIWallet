...
class Accounts_model extends BF_Model
{
    ...
    */
    ...
    public function getUserPlaidPublicKey($cuID) {
        $this->db->from('bf_users_plaid_keys'); 
        $this->db->where('created_by', $cuID); 
        $getUserPlaidPublicKey          = $this->db->get(); 
        return $getUserPlaidPublicKey; 
    }
    /*
    ...
    public function get_user_ach_bank_accounts($cuID) {
        $this->db->from('bf_users_bank_accounts'); 
        $this->db->where('user_id', $cuID); 
        $this->db->where('status', 1); 
        $this->db->where('ach_enabled', 1); 
        $getUserACHBankAccounts             = $this->db->get();
        return $getUserACHBankAccounts;
    }
    ...
    public function get_user_debt_accounts($cuID)
    {
    ...
    public function get_accounting_account_info($accountID) {
        $this->db->from('bf_users_accounting_accounts');
    ...
    public function get_credit_account_info($accountID) {
        $this->db->from('bf_users_credit_accounts');
        $this->db->where('id', $accountID); 
        $getBankAccount                 = $this->db->get();
        return $getBankAccount;
    ...
    public function get_ecommerce_account_info($accountID) {
        $this->db->from('bf_users_credit_accounts');
        $this->db->where('id', $accountID); 
        $getBankAccount                 = $this->db->get();
        return $getBankAccount;
    ...
    public function get_investment_account_info($accountID) {
        $this->db->from('bf_users_credit_accounts');
        $this->db->where('id', $accountID); 
        $getBankAccount                 = $this->db->get();
        return $getBankAccount;
