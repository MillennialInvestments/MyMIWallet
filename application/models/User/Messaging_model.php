...
class Messaging_model extends BF_Model
{
    ...
    */
     ...
     */
    public function send($date_submitted, $time, $sender_id, $sender_username, $receiver, $details)
    {
        $user = array(
        ...
        return $this->db->insert('bf_messages', $user);
    }
