...
class Advisor_model extends BF_Model
{
    ...
    */
    ...
    public function get_cfa_advisor_info($cfaReferralCode) {
        $this->db->from('bf_cfa_advisors');
        $this->db->where('referral_code', $cfaReferralCode);
        $getCFAInfo                         = $this->db->get(); 
        return $getCFAInfo;
    }

    public function get_cfa_customer_info($cfaCustID) {
        $this->db->from('bf_cfa_customers');
        $this->db->where('id', $cfaCustID);
        $getCustomers                       = $this->db->get();
        return $getCustomers;
    }
}