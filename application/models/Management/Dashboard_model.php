...
class Dashboard_model extends BF_Model
{
    ...
    */
    ...
    public function add_dashboard($dashboard, $dashboard_link)
    {
        $user = array(
            'dashboard'					=> $dashboard,
        ...
        return $this->db->insert('bf_dashboards', $user);
    }
    ...
    */
    ...
    public function update_indash_status($id, $subpage_status)
    {
        $user = array(
            'subpage_status' => $subpage_status,
        );
    ...
    */
    ...
    public function edit_construction_tasks($id, $assigner_id, $user_id, $dashboard, $tasks, $details)
    {
        $user = array(
            'assigner_id'				=> $assigner_id,
            'user_id'					=> $user_id,
    ...
    public function edit_construction_subtasks($id, $subtasks, $details)
    {
        $user = array(
            'subtasks'					=> $subtasks,
            'details'					=> $details,
