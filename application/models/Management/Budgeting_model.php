...
class Budgeting_model extends BF_Model
{
    ...
    */
    ...
    public function get_debt_collector_errors() {
        $this->db->from('bf_users_budgeting'); 
        $this->db->like('source_type', 'Debt'); 
        $this->db->or_like('source_type', 'Loan'); 
        $this->db->where('is_debt', 0);
        $getActiveDebtErrors                    = $this->db->get(); 
        return $getActiveDebtErrors;         
    }
    ...
    public function debt_collector_cleanup() {
        ...
        $this->db->where('is_debt', 0); 
        $this->db->where('source_type', 'Debt'); 
        $this->db->or_where('source_type', 'Loan'); 
        return $this->db->update('bf_users_budgeting', $debtUpdate); 
    }
}
