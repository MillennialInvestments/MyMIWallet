    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                ?>
                <input type="checkbox" name="role_permissions[]" class="" value="<?php echo $currentRolePermission['perm_id']; ?>"<?php if (isset($currentRolePermission['value']) && $currentRolePermission['value'] == 1) {
