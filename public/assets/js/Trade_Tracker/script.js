    ...
    cancelSaveToggler() {
        ...
        if (this.state.editing) {
            ...
            if (!this.structure[gin("b2")].hasCancelListener) {
                ...
                this.structure[gin("b2")].target.classList.add("btn", "btn-warning", "h-100");
                this.structure[gin("b1")].target.classList.add("btn", "btn-success", "h-100");
            ...
            this.structure[gin("b2")].target.classList.add("disabled-btn", "btn", "btn-dim", "btn-outline-light", "disabled");
            this.structure[gin("b1")].target.classList.add("disabled-btn", "btn", "btn-dim", "btn-outline-light", "disabled");
        ...
        switch (dirProperties.type) {
            case "input":
                ...
                switch (dirProperties.subtype) {
                    case "text":
                        ...
                        field.classList.add("form-control", "text-center", "px-1");
                        break;
                    case "locked":
                        field.setAttribute("type", "text");
            ...
            case "choice":
                switch (dirProperties.subtype) {
                    ...
                    case "select":
                        field = spawnSelect();
                        field.classList.add("form-control", "selectpicker")
            ...
            case "closed":
                ...
                if (this.getValue(gin("1")).value == "true") {
                    ...
                    field.classList.add("btn", "btn-block", "btn-light", "h-100");
                    field.onclick = this.open;
                }
                else {
                    field.innerHTML = "Close";
                    field.classList.add("btn", "btn-block", "btn-warning", "h-100");
                    //ADD EVENT LISTENER
            ...
            case "button":
                ...
                field.classList.add("btn", "btn-block", "h-100"); 
                ...
                switch (dirProperties.subtype) {
                    ...
                    case "cancel":
                        field.classList.add("btn-warning"); 
                        break;
                    case "save":
...
newRowButton.classList.add("new-btn", 'btn', "h-100", "btn-primary", "mr-3");
...
editPrefsBtn.classList.add("new-btn", "btn", "btn-primary", "h-100");
