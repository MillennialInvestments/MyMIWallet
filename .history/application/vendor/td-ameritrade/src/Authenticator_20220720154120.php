...
class Authenticator {
     ...
     */
    protected $oauthConsumerKey = 'XGCE3NA1BXIGQG2NHDTLHZ6OUSIZTITF';
     ...
     */
    public $loadedFromRefreshToken = TRUE;
    ...
    public function authenticate_v2(): TDAmeritradeAPI {
        $this->debug = $debug;
...
//        die($postLoginPageInnerHTML);
    ...
    public function authenticate( bool $debug = TRUE ): TDAmeritradeAPI {
        $this->debug = $debug;
