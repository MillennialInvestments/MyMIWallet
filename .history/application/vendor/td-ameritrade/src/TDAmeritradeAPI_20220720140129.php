...
use MichaelDrennen\TDAmeritradeAPI\Traits\APIClientTrait;
...
class TDAmeritradeAPI {
   ...
   public function login( string $oauthConsumerKey, string $userName, string $password, string $callbackUrl,                           bool $debug = FALSE ) 
    {
       $this->userName = $userName;
