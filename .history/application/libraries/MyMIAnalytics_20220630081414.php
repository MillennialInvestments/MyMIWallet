...
class MyMIAnalytics
{
    ...
    {    
        ...
        $partnerAssetPercentage             = (($approvedPartnerAssets['totalApprovedAssets'] / $target['targetAssets']) * 100) . '%'; 
        ...
        $reporting                          = array(
            ...
            'getPendingPartnerSupport'      => $pendingSupport['getPendingPartnerS']
