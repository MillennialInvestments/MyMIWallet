...
class MyMIWallet
{
    ...
    public function get_default_wallet_info($cuID)
    {
        ...
        if (empty($getUserDefaultWallet)) {
            ...
            $wallet_type		= 'Fiat';
            $amount				= '0.00';
            $this->user_model->add_default_wallet_for_existing($id, $active, $beta, $default_wallet, $exchange_wallet, $market_pair, $market, $username, $email, $broker, $wallet_type, $amount, $nickname);
