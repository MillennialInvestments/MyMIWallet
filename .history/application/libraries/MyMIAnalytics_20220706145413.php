...
class MyMIAnalytics
{
    ...
    {    
        ...
        $partnerTransAmountPercentage       = number_format((($totalAmounts['totalPartnerTransTotals'] / $target['targetPartnerTransAmount']) * 100),2) . '%'; 
        ...
        $reporting                          = array(
            ...
            'partnerTransationPercentage'   => $partnerTransationPercentage,
    ...
    public function targets() {
        ...
        $target                             = array(
            ...
            'targetPartnerTransFees'           => $targetPartnerTransAmount,            
        );
    ...
    public function get_total_amount() {
        ...
        foreach($getTotalPartnerAmounts as $partnerAssets) {
