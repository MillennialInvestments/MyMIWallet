...
class MyMIAnalytics
{
    ...
    {    
        ...
        $transactionPercentage              = ($totalTransOrders['totalTransaction'] / $target['targetTransactions']) * 100 . '%'; 
        $transAmountPercentage              = ($approvedAssets['totalTransAmount'] / $target['targetTransAmounts']) * 100 . '%'; 
        $transFeesPercentage                = ($approvedAssets['totalTransFees'] / $target['targetTransFees']) * 100 . '%'; 
        $tradesPercentage                   = ($approvedAssets['totalTrades'] / $target['targetTrades']) * 100 . '%'; 
        $partnerPercentage                  = ($approvedAssets['totalActivePartners'] / $target['targetPartners']) * 100 . '%'; 
        $usersPercentage                    = ($approvedAssets['totalActiveUsers'] / $target['targetUsers']) * 100 . '%'; 
        $walletsPercentage                  = ($approvedAssets['totalActiveWallets'] / $target['targetWallets']) * 100 . '%'; 
        ...
        $reporting                          = array(
            ...
            'targetTransAmounts'            => $target['targetTransAmounts'],
    ...
    public function targets() {
        ...
        $target                             = array(
            ...
            'targetTransAmounts'            => $targetTransAmounts,
