...
class MyMILogger {
   ...
   * @return $this
   */
  public function full_url($full_url) {
  ...
  public function log() {
    $data        = array(
      ...
      $this->table_fields['full_url']   => $this->full_url,
  ...
  protected function _getQueryMaker() {
    ...
    if ($this->full_url)
      $this->ci->db->where($this->table_fields['full_url'], $this->full_url);
    if ($this->token)
