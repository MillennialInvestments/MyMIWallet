...
class MyMIAnalytics
{
    ...
    {    
        ...
        // $tradesPercentage                   = ($trackedTrades['totalTrades'] / $target['targetTrades']) * 100 . '%'; 
        ...
        // $walletsPercentage                  = ($activeWallets['totalActiveWallets'] / $target['targetWallets']) * 100 . '%'; 
        ...
        $reporting                          = array(
            ...
            'totalTransFeesPlain'           => $totalAmounts['totalTransFessPlain'],
            'totalTransTotalPlain'          => $totalAmounts['totalTransTotalPlain'],
