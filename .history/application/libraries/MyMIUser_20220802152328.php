...
class MyMIUser
{
    ...
    public function get_user_default_wallet($cuID)
    {
        if (empty($userDefaultWalletInfo)) {
            $userDefaultWalletInfo                       = $this->get_user_information($cuID);
            $active				            = 'Yes';
            $beta                           = 'Yes'; 
            $default_wallet		            = 'Yes';
            $exchange_wallet	            = 'Yes';
            ...
            $userDefaultData				= array(
                'cuID'                      => $cuID,
                'cuEmail'                   => $userData['cuEmail'],
                'cuUsername'				=> $userData['cuUsername'],
                'cuDisplayName'				=> $userData['cuDisplayName'],
                'cuUserType'				=> $userData['cuUserType'],
                'cuWalletID'				=> $userData['cuWalletID'],
