...
class Budget_model extends BF_Model
{
    ...
    */
     ...
     */
    public function add_account($created_by, $created_by_date, $unix_timestamp, $month, $day, $year, $time, $status, $account_type, $source_type, $intervals, $name, $am0unt, $designated_date)
    {
        $user_data                  = array(
