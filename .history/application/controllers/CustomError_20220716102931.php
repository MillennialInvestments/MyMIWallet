 ...
 *
 */
class CustomError extends MX_Controller
{
    ...
    public function index()
    {
        $pageType = 'Standard';
        $pageName = 'Home';
        $this->set_current_user();Header('Access-Control-Allow-Origin: *'); //for allow any domain, insecure
        ...
        Template::set_view('errors/html/error_404'); 
        Template::render();
    }//end index()
