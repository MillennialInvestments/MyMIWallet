...
if ($this->uri->segment(1) === 'Management') {
    ...
    if (!empty($appID)) {
        ...
        echo '<input type="hidden" class="form-control" name="application_id" id="application_id" value="''<?php echo ''set_value('application_id', isset($user) ? $user->application_id : $appID); ?>" hidden>	
    } else {
        $blockchain					= '';
...
<div class="<?php echo $formGroup; ?>">    
	...
	<div class="<?php echo $formConCol; ?>">
		<?php
            ...
            echo '
			<select class="' . $formSelectPicker . '" name="blockchain" id="blockchain" data-live-search="true" required="required">			
