...
<div class="<?php echo $formGroup; ?>">    
	...
	<div class="<?php echo $formConCol; ?>">
		<?php
            ...
            echo '
			<select class="form-control" name="blockchain" id="blockchain" data-live-search="true" required="required">			
...
<div class="<?php echo $formGroup; ?>">    
	...
	<div class="<?php echo $formConCol; ?>">
		<?php
            echo '
			<select class="form-controlsa" name="purpose" id="purpose" data-live-search="true" required="required">				
