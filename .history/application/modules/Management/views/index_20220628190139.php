			...
			<div class="nk-block">
				<div class="nk-block-head-xs">
					<div class="nk-block-head-content">
						...
						<p id="private_key"></p>
						<p id="address"></p>
						<a href="<?php echo site_url('/Trade-Tracker'); ?>">Back to Dashboard <?php echo floatval($reporting['totalTransTotalsPlain']P . ' ' . $reporting['targetTransAmount']; ?></a>							
					</div>
				</div>
			</div>
			<div class="nk-block">
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <h4><?php echo number_format($totalApprovedAssets,0); ?><small class="text-muted fs-14px"><br><small class="fs-20px">Total Assets</small></h4>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <div class="align-self-center text-end">
                                            <h4><?php echo number_format($totalTransactions,0); ?><br><small class="fs-20px">Total Orders</small></h4>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <div class="align-self-center text-end">
                                            <h4><?php echo number_format($totalTradesTracked,0); ?><br><small class="fs-20px">Total Trades</small></h4>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
