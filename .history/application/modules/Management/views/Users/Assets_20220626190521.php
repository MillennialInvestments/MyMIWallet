                    ...
                    <div class="col-md-6 col-lg-8">
                        <div class="card card-bordered card-full">
                            ...
                            <div class="user-activity-ck">
                                <canvas class="order-overview-chart chartjs-render-monitor" id="userAssetProgressChart" style="display: block; width: 491px; height: 260px;" width="491" height="260"></canvas>
                                <canvas class="line-chart" id="userAssetProgressChart" style="width:100%;max-width:600px;height:100%"></canvas>
                            </div>
                        </div><!-- .card -->
                    </div>
                </div>
