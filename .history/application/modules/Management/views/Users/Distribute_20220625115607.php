                        ...
                        <div class="card card-bordered">
                            <div class="card-inner">
                                ...
                                <form action="#">
                                    ...
                                    <input class="" onChange="calculateByCoinAmount(); return false;" type="hidden" id="total_fees" name="total_fees" value="<?php echo set_value('total_fees', isset($user) ? $user->total_fees : ''); ?>" /brew install code-serverz
                                    ...
                                    <tr class="tb-odr-item">
                                        ...
                                        <td class="tb-odr-amount">
                                            ...
                                            <span class="tb-odr-status">
                                                <span class="badge badge-dot bg-warning">' . $userOrder['status'] . '</span>
                                            </span>
                                        </td>
