                        ...
                        <div class="card card-bordered">
                            <div class="card-inner">
                                ...
                                <form action="#">
                                    ...
                                    <input class="" onChange="calculateByCoinAmount(); return false;" type="hidden" id="total_fees" name="total_fees" value="<?php echo set_value('total_fees', isset($user) ? $user->total_fees : ''); ?>" /brew 
