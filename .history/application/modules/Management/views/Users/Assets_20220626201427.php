...
const myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: [<?php echo '\'' . date('M - y',strtotime('M - 12 months')) . '\',' . '\'' . date('M - y',strtotime('M - 11 months')) . '\',' . '\'' . date('M - y',strtotime('M - 10 months')) . '\',' . '\'' . date('M - y',strtotime('M - 9 months')) . '\',' . '\'' . date('M - y',strtotime('M - 8 months')) . '\',' . '\'' . date('M - y',strtotime('M - 7 months')) . '\',' . date('M - y',strtotime('M - 6 months')) . '\',' . date('M - y',strtotime('M - 5 months')) . '\',' . date('M - y',strtotime('M - 12 months')) . '\','; ?>],
