                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <h4><?php echo number_format($totalApprovedAssets,0); ?><small class="fs-14px"><?php echo $targetAset $assetPercentage; ?></small><br><small class="fs-20px">Total Assets</small></h4>
