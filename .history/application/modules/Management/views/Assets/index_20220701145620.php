                                ...
                                <div class="card-inner">
                                    <div class="nk-wg-action">
                                        <div class="nk-wg-action-content">
                                            ...
                                            <p><a href="<?php echo site_url('/ManagementAssetsA[["><strong><?php echo $totalPendingAssets; ?> Pending Assets</strong></a> and <strong><?php echo $totalApprovedAssets; ?> Asset Approvals</strong>, thats need to be reviewed.</p>
                                        </div>
