                                ...
                                <div class="card-inner">
                                    <div class="nk-wg-action">
                                        <div class="nk-wg-action-content">
                                            ...
                                            <p>There is <a href="<?php echo site_url('/Management/Assets/Support/Requests'); ?>"><strong><?php echo $totalPendingSupport; ?></strong></a> support messages and <a href="<?php echo site_url('/Management/Assets/Support'<strong><?php echo $totalCompleteSupport; ?></strong> completed request. </p>
                                        </div>
