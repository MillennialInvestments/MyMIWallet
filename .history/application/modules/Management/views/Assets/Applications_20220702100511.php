                                            ...
                                            <div class="row g-4">
                                                <div class="col-sm-6 col-xxl-12">
                                                    <div class="nk-order-ovwg-data buy">
                                                        ...
                                                        <div class="info">Last month <strong><?php echo <?php echo 'Last Month\'s Numbers {HERE}'; ?>//$totalLastApprovedAssets; ?> <span class="currenct currency-usd">USD</span></strong></div>
