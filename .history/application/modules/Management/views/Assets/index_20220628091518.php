...
$getApprovedAssests                 = $reporting['getApprovedAssets'];
...
$getTotalAmounts                    = $reporting['getTotalAmounts']; $totalTransFees             = '<strong>$' . number_format($totalAmounts['fees'],2) . '</strong>';
