                                    ...
                                    <div class="card-title-group">
                                        ...
                                        <div class="card-tools me-n1">
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="<?php echo site_url('Management/Assets/Support/Requests'); ?>"><em class="icon ni ni-setting"></em><span>Manage Support</span></a></li>
                                                        <li><a href="<?php echo site_url('Management/Assets/Support/Requests'); ?>"><em class="icon ni ni-notify"></em><span>View Pending Assets</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
