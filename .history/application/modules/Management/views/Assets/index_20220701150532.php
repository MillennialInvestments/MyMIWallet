                                ...
                                <div class="card-inner">
                                    <div class="nk-wg-action">
                                        <div class="nk-wg-action-content">
                                            ...
                                            <p>We have reached <a href="<?php echo site_url('Management/Assets/Transactions'); ?>"><strong><?php echo $totalTransactions; ?> Total Transactions</strong></a>, <a href="<?php echo site_url('Management/Assets/Transactions'); ?>"><strong><?php echo $totalTransTotals; ?> Total Spend</strong></a>, and <strong><?php echo $totalTransFees; ?> Total</strong> in Transactional Fees.</p>
                                        </div>
