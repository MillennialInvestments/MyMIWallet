                                ...
                                <div class="card-inner">
                                    <div class="nk-wg-action">
                                        <div class="nk-wg-action-content">
                                            ...
                                            <p><a href="<?php echo site_url('/ManagementAssets/Applications'); ?>"><strong><?php echo $totalPendingAssets; ?> Pending Assets</strong></a> and <a href=, thats need to be reviewed.</p>
                                        </div>
