                                ...
                                <div class="card-inner">
                                    <div class="nk-wg-action">
                                        <div class="nk-wg-action-content">
                                            ...
                                            <p><strong><?php echo $totalApprovedAssets; ?> Pending Applications</strong> and <strong><?php echo $totalActivePartners; ?> Total Partners</strong>, thats need to be reviewed.</p>
                                        </div>
