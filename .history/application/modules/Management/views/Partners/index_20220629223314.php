                                ...
                                <div class="project">
                                    ...
                                    <div class="project-progress">
                                        <div class="project-progress-details">
                                            <div class="project-progress-task"><em class="icon ni ni-check-round-cut"></em><span><?php echo $totalActivePartners; ?></span></div>
                                            <div class="project-progress-percent">partnerPercentage%</div>
                                        </div>
