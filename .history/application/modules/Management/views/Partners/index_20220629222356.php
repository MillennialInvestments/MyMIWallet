                                            ...
                                            <div class="row g-4">
                                                <div class="col-sm-6 col-xxl-12">
                                                    <div class="nk-order-ovwg-data buy">
                                                        ...
                                                        <div class="info">Last month <strong><?php echo 'Last Months Number {HERE}' //$totalLastActicePartners; ?> <span class="currenct currency-usd">Pending Par</span></strong></div>
