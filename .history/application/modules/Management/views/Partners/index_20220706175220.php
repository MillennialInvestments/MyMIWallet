                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex pb-md-4">
                                        ...
                                        <div class="align-self-center text-end">
                                            <h6>
                                                <?php echo $totalPartnerTransFees; ?>
                                                <small class="fs-14px"> / <?php echo $targetPartnerTransFees . ' (' . $partnerTransFeesPercentage . ')'; ?></small>
                                                <br>
                        ...
                        <div class="card card-bordered h-100">
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    ...
                                    <a href="<?php echo site_url('Management/Assets'); ?>" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Manage R</a>
                                </div>
                            </div>
                        </div>
                    </div>
