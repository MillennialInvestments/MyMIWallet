...
$totalPartnerSupportRequests        = $reporting['totalPartnerSupportRequests'];
                        ...
                        <div class="card card-bordered h-100">
                            <div class="card-inner-group">
                                <div class="card-inner card-inner-md">
                                    <div class="card-title-group">
                                        <div class="card-title">
                                            <h6 class="title">Transaction Totals</h6>
                                        </div>
                                        <div class="card-tools me-n1">
                                            <div class="drodown">
                                                <a href="#" class="dropdown-toggle btn btn-icon btn-trigger" data-bs-toggle="dropdown"><em class="icon ni ni-more-h"></em></a>
                                ...
                                <div class="card-inner">
                                    <div class="d-flex pb-md-4">
                                        ...
                                        <div class="align-self-center text-end">
                                            <h6>
                                                <?php echo number_format($totalPartnerSupportRequests,0); ?>
                                                <small class="fs-14px"> / <?php echo $targetPartnerSupportRequest . ' (' . $partnerSupportRequestPercentage . ')'; ?></small>
                                                <br>
                        ...
                        <div class="card card-bordered h-100">
                            <div class="card-inner-group">
                                <div class="card-inner card-inner-md">
                                    <div class="card-title-group">
                                        <div class="card-title">
                                            <h5 class="title">Transactions Fees</h5>
                                        </div>
                                        <div class="card-tools me-n1">
                                            <div class="drodown">
                                                <a href="#" class="dropdown-toggle btn btn-icon btn-trigger" data-bs-toggle="dropdown"><em class="icon ni ni-more-h"></em></a>
