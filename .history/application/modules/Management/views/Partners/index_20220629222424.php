                                            ...
                                            <div class="row g-4">
                                                <div class="col-sm-6 col-xxl-12">
                                                    <div class="nk-order-ovwg-data buy">
                                                        ...
                                                        <div class="info">Last month <strong><?php echo 'Last Months Number {HERE}' //$totalLastActicePartners; ?> <span class="currenct currency-usd">Pending Applicaions</span></strong></div>
                                                ...
                                                <div class="col-sm-6 col-xxl-12">
                                                    <div class="nk-order-ovwg-data sell">
                                                        ...
                                                        <div class="title"><em class="icon ni ni-arrow-up-left"></em> Pending Partner Appliations</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- .col -->
