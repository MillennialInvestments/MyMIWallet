			...
			<div class="nk-block">
				<div class="nk-block-head-xs">
					<div class="nk-block-head-content">
                        ...
                        <?php 
                        $test = number_format($reporting['totalTransTotalsPlain'],2) / number_format($reporting['targetTransAmount'],2); 
                        echo $test;
                        ?>							
					</div>
				</div>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <h5><?php echo number_format($totalApprovedAssets,0); ?><small class="fs-14px"> / <?php echo $targetAssets . ' (' . $assetPercentage . ')'; ?></small><br><small class="fs-20px">Total Assets</small></h5>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <div class="align-self-center text-end">
                                            <h5><?php echo number_format($totalTransactions,0); ?><br><small class="fs-20px">Total Orders</small></h5>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <div class="align-self-center text-end">
                                            <h5><?php echo number_format($totalTradesTracked,0); ?><br><small class="fs-20px">Total Trades</small></h4>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <div class="align-self-center text-end">
                                            <h5><?php echo number_format($totalActivePartners,0); ?><br><small class="fs-20px">Active Partners</small></h5>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
                        ...
                        <div class="card card-bordered h-100">
                            <div class="card-inner-group">
                                <div class="card-inner card-inner-md">
                                    <div class="card-title-group">
                                        <div class="card-title">
                                            <h5 class="title">User Accounts</h5>
                                        </div>
                                        <div class="card-tools me-n1">
                                            <div class="drodown">
                                                <a href="#" class="dropdown-toggle btn btn-icon btn-trigger" data-bs-toggle="dropdown"><em class="icon ni ni-more-h"></em></a>
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <div class="align-self-center text-end">
                                            <h4><?php echo number_format($totalActiveUsers,0); ?><br><small class="fs-20px">Active Users</small></h4>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <div class="align-self-center text-end">
                                            <h4><?php echo number_format($totalWalletsCreated,0); ?><br><small class="fs-20px">Total Wallets</small></h3>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
