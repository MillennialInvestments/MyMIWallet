...
$totalActivePartners                = $reporting['totalActiveP']
?>
<div class="nk-block">
	<div class="row gy-gs">
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <h3><?php echo $totalApprovedAssets; ?> <small class="fs-20px">Total Assets</small></h3>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <div class="align-self-center text-end">
                                            <h3><?php echo $totalTransactions; ?> <small class="fs-20px">Total Orders</small></h3>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <div class="align-self-center text-end">
                                            <h3><?php echo $totalTradesTracked; ?> <small class="fs-20px">Total Trades</small></h3>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <div class="align-self-center text-end">
                                            <h3><?php echo $totalActiveUsers; ?> <small class="fs-20px">Active Users</small></h3>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex px-3 py-md-5">
                                        ...
                                        <div class="align-self-center text-end">
                                            <h3><?php echo $totalWalletsCreated; ?> <small class="fs-20px">Total Wallets</small></h3>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
