...
$totalWalletsCreated                = $reporting['totalWalletsCreat']
?>
<div class="nk-block">
	<div class="row gy-gs">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="card card-bordered h-100">
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex justify-content-between px-md-1 py-md-5">
                                        <div class="align-self-center">
                                        <i class="icon icon-lg ni ni-coins"></i>
                                        </div>
                                        <div class="text-end">
                                        <h2><?php echo $totalApprovedAssets; ?> <small>Total Assets</small></h2>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex justify-content-between px-md-1 py-md-5">
                                        ...
                                        <div class="text-end">
                                            <h2><?php echo $totalTransactions; ?> <small>Total Orders</small></h2>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex justify-content-between px-md-1 py-md-5">
                                        ...
                                        <div class="text-end">
                                            <h2><?php echo $totalTradesTracked; ?> <small>Total Trades</small></h2>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner">
                                    <div class="d-flex justify-content-between px-md-1 py-md-5">
                                        ...
                                        <div class="text-end">
                                            <h2><?php echo $totalWalletsCreated; ?> <small>Total Wallets</small></h2>
                                        </div>
                                    </div>
                                    <a href="#" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> Watch Now</a>
                                </div>
