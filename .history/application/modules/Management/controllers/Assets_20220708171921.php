    ...
    public function Approval($appID)
    {
        ...
        if ($pageURID === 'Approve') {
            ...
            if ($assetStatus === 'Approved') {
                $migrateAssetInfo                               = $this->mymianalytics->migrate_asset_request_info($appID);
                Template::set_message('success', 'Asset Application has been Approved!');
                Template::redirect('/Management/Assets/Application/Details/' . $appID . '/Approved'); 
                ...
                if ($this->analytical_model->update_pending_asset_status($appID, $assetStatus)) {
                    ...
                    Template::redirect('/Management/Assets/Application/Details/' . $appID . '/Denied'); 
                }
            }
        }
    }
