...
class Users extends Admin_Controller
{
    ...
    {
        if($this->users_model->block_user($userID)) {
            Template::set_message('User Blocked Successfully', 'success');
            Template::redirect('/Management/Users');
        }
    }
    ...
    public function Force_Reset($userID)
    {
        if($this->users_model->force_reset($userID)) {
            Template::set_message('User Forced Reset Submitted Successfully', 'success');
            Template::redirect('/Management/Users');
        }
    }
    ...
    public function Orders($userID)
    {
        $pageType = 'Standard';
        $pageName = 'Web_Design_Dashboard';
        $this->load->library(array('users/auth', ));
        $this->set_current_user();
