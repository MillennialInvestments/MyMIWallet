                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                Also, when you create Assets to place on the Exchange, you will be giving a designated wallet to secure those assets in a dedicated wallet for protection in case you ever lose your Private/Public Keys to once of your MyMI Wallets.r

                                            </p>
                                            <p class="lead fs-14px">
                                                MyMI Wallets also come with a Premium Brokerage Integration Feature that allows our Investors to connect their financial investment accounts to. 
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="<?php // echo site_url('Support/Check-KYC-Verification'); ?>"></a></li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
