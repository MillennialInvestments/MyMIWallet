                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                View the following article for more details on account types.
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="<?php echo site_url('Knowledge-Base/Types_Of_Accounts'); ?>">Types of Accounts</a></li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="#<?php echo site_url('Support/Check-KCY'); ?>">Check KYC Status</a></li>
                                                </ul>
                                                <br>
                                                <br>
