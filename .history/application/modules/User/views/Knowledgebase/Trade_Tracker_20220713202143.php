    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            <div class="content-page">
                            ...
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h4 class="nk-block-title fw-normal"><i class="icon icon-md ni ni-spark"></i> MyMI Trade Tracker</h4>
                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                This article will cover a majority of what our Trade Tracker is designed to do by default, but we provide links to more in-depth information regarding certain functionality and 
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row" id="manually-integrated-wallets"></div>
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h5 class="nk-block-title fw-normal pb-3">Manually Tracking Investments</h5>
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                ...
                                <div class="card">
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <p class="lead fs-14px">
                                                By compiling all of your financial investment analytics and data, you gain the ability to access our <strong>Auctionable Assets Exchange</strong> and profit from simply sharing your data. 
                                                <strong>Read more below!</strong>
                                            </p>
                                        </div>
                                    </div>
                                </div>
