                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="<?php echo site_url('Support'); ?>">Submit A Ticket</a></li>
                                                    <li class="list-group-item"><a href="<?php echo $facebookPage; ?>">Facebook</a></li>
                                                    <li class="list-group-item"><a href="<?php echo $twitterPage; ?>">Twitter</a></li>
                                                    <li class="list-group-item"><a href="<?php echo $stocktwitsPage; ?>">Stocktwits</a></li>
                                                    <li class="list-group-item"><a href="<?php echo $discordPage; ?>">Discord</a></li>
                                                </ul>           
                                            </p>
                                            <div class="row">
                                                <div class="col"><a href="<?php echo site_url('Support'); ?>">Submit A Ticket</a></div>           
                                                <div class="col"><a href="<?php echo $facebookPage; ?>">Facebook</a></div>           
                                                <div class="col"><a href="<?php echo $twitterPage; ?>">Twitter</a></div>           
                                                <div class="col"><a href="<?php echo $stocktwitsPage; ?>">Stocktwits</a></div>        
                                            </div>
                                        </div>
                                    </div>
                                </div>
