                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <p class="lead fs-14px">   
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item"><span></span><span><?php echo $MyMIGold_TierTwo; ?> MyMI Gold</span></li>
                                                    <li class="list-group-item"><span></span><span><?php echo $MyMIGold_TierThree; ?> MyMI Gold/span></li>
                                                    <li class="list-group-item"><span></span><span><?php echo $MyMIGold_TierFour; ?> MyMI Gold</span></li>
                                                    <li class="list-group-item"><span></span><span><?php echo $MyMIGold_TierFive; ?> MyMI Gold</span></li>
