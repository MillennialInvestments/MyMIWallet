                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">   
                                                ...
                                                For any additional information that may be required such as KYC Verification Documentation, Required Company Documentation for our Partner Program will be requested on a per-account basis. 
                                                All requests for information will be provided with notification via email (<a href="mailto:support@mymiwallet.com">support@mymiwallet.com</a>) and completing within the MyMI Wallet                              
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h3 class="nk-block-title fw-normal">Partnership Integration</h3>
                                        <div class="nk-block-des">
                                            <p class="lead">
                                            </p>
                                        </div>
