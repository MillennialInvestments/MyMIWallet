                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                View the following article for instructions on how to register an MyMI Wallet Account.
                            ...
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                Once you have completed the <a href="">Sign-Up Process</a>, you will receive an email with notifying you that your account has been created. 
                                                ...
                                                <br>
                                                To login, use the credentials you selected for the account during registration.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                To comply with Anti-Money Launering (AML) Laws, we require KYC Verification of all members in the MyMI Community to protect and provide safety in our Investment Platform. 
                                                KYC Verification is the process of verifying your identity and financial activities to ensure safety from risks of
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="<?php echo site_url('Support/Check-KYC-Verification'); ?>">KYC Process &amp; Requirements</a></li>
