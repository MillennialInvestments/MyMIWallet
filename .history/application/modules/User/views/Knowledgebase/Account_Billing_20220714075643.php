    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            <div class="content-page">
                ...
                <div class="row" id="how-billing-works"></div>
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">   
                                                ...
                                                We wanted to take the opportunity to allow our members to develop customizable membership packages to only access the resources they need to conduct their investment accounting & analytical studie                                
                                            </p>
                                        </div>
                                    </div>
                                </div>
