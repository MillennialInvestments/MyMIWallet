                            ...
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                Once you have completed the <a href="">Sign-Up Process</a>, you will receive an email with notifying you that your account has been created To gain access to your account and Investor Dashboard, visit <a href="<?php echo site_url('login'); ?>">https://www.mymiwallet.com/login</a>.<br> 
