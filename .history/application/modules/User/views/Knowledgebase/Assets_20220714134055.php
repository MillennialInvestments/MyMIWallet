    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            <div class="content-page">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">   
                                                ...
                                                */
                                                ...
                                                <dl class="row">
                                                    <dt class="col-sm-3">Currency Token</dt>
                                                    <dd class="col-sm-9">{Definition Here}</dd>
                                                </dl>
                                                <dl class="row">
                                                    <dt class="col-sm-3">Equity Token</dt>
                                                    <dd class="col-sm-9">{Definition Here}</dd>
                                                </dl>
                                                <dl class="row">
                                                    <dt class="col-sm-3">NFT Token</dt>
                                                    <dd class="col-sm-9">{Definition Here}</dd>
                                                </dl>
                                                <dl class="row">
                                                    <dt class="col-sm-3">Reward Token</dt>
                                                    <dd class="col-sm-9">{Definition Here}</dd>
                                                </dl>
                                                <dl class="row">
                                                    <dt class="col-sm-3">Utility Token</dt>
                                                    <dd class="col-sm-9">{Definition Here}</dd>
                                                </dl>
                                            </p>
                                        </div>
                ...
                <div class="row" id="creating-assets"></div>
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h5 class="nk-block-title fw-normal pb-3">Creating Assets</h5>
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">       
                                                You have the ability to create MyMI Assets and begin your own investment pools/projects that you can offer to the Marketplace and Exchange. 
                ...
                <div class="row" id="listing-assets"></div>
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
