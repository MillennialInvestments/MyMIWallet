                            ...
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px"> 
                                                After integrating a MyMI Wallet (whether manually imported or created via the Premium Brokerage Integration), Investors gain the option to activate the Premium Trade Tracker features
                                            </p>
                                        </div>
                                    </div>
                                </div>
