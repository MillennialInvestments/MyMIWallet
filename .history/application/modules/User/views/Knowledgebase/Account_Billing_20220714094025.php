...
$MyMIGold_TierOne                       = $this->config->item('tier_two');
$MyMIGold_TierOne                       = $this->config->item('tier_three');
$MyMIGold_TierOne                       = $this->config->item('tier_four');
$MyMIGold_TierOne                       = $this->config->item('tier_five');
?>
