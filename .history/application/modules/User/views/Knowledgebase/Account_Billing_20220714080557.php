                            ...
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">        
                                                Premium Features are purchased on a Month-to-Month Basis (a recurring cost) and what our members are required to pay on a monthly basis is determined by the Premium Features activated on their account, 
                                                along with the Total Number of each Premium Feature(s) the member has purchased.                   
                                            </p>
                                            <p class="lead fs-14px">        
                                                Invoicing for all Premium Features is conducted on the 14th of every month and automatic payments are setup to obtain funds to cover the cost of those Premium Features on the 15th of every month. 
                                                The allocation of funds will first check the MyMI Gold Balance of a member's account first and retrieve the required amount of funds in MyMI Gold first. 
                                                If the user doesn't not have enough to cover the cost of their Monthly Recurring Premium Feature Costs, the member will be notified to purchase additional MyMI Gold to cover that                    
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h3 class="nk-block-title fw-normal">Distribution Schedule</h3>
                                        <div class="nk-block-des">
                                            <p class="lead">
                                            </p>
                                        </div>
