                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <p class="lead fs-14px">   
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><?php echo $MyMIGold_TierOne M; ?></li>
                                                    <li class="list-group-item"><?php echo $MyMIGold_TierTwo; ?></li>
                                                    <li class="list-group-item"><?php echo $MyMIGold_TierThree; ?></li>
                                                    <li class="list-group-item"><?php echo $MyMIGold_TierFour; ?></li>
                                                    <li class="list-group-item"><?php echo $MyMIGold_TierFive; ?></li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
