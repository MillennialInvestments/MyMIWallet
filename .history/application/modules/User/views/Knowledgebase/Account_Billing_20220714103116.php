                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col"><a class="btn btn-outline-primary" href="<?php echo $twitterPage; ?>"><em class="icon ni ni-tw"></em> Twitter</a></div>                  
                                                <div class="col"><a class="btn btn-outline-primary" href="<?php echo $discordPage; ?>">Discord</a></div>       
                                                <div class="col"><a class="btn btn-outline-primary" href="<?php echo $stocktwitsPage; ?>">Stocktwits</a></div>        
                                            </div>
                                        </div>
                                    </div>
                                </div>
