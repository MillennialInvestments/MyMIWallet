                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="<?php echo site_url($free_registratio); ?>">Register Account</a></li>
                                                </ul>
                                            </p>
                                            <p class="lead fs-14px">
                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="<?php echo site_url('Knowledge-Base/Integrating-Wallets#completing-kyc-verification'); ?>">What are MyMI Wallet</a></li>
                                                </ul>       
                                            </p>
                                            <p class="lead fs-14px">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item"><a href="<?php echo site_url('Knowledge-Base/Integrating-Wallets#manually-integrated-wallets'); ?>">How to Integrate Brokerage Accounts</a></li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
