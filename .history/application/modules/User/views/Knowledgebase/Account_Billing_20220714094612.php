                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <p class="lead fs-14px">   
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item"><?php echo $MyMIGold_TierTwo; ?> MyMI Gold</li>
                                                    <li class="list-group-item"><?php echo $MyMIGold_TierThree; ?> MyMI Gold</li>
                                                    <li class="list-group-item"><?php echo $MyMIGold_TierFour; ?> MyMI Gold</li>
                                                    <li class="list-group-item"><?php echo $MyMIGold_TierFive; ?> MyMI Gold</li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
