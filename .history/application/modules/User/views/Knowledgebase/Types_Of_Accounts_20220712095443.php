    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            <div class="content-page">
                                ...
                                <div class="card">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                <ul class="link-list-plain">
                                                    <li><a href="#creating-account">Creating a MyMI Account</a></li>
                                                    <li><a href="#kyc-verification">KYC Verification</a></li>
                                                    <li><a href="#configuring-investor-profile">Configuring Investor Profile</a></li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                <ul class="link-list-plain">
                                                    <li><a href="#integrating-wallets">Integrating Wallets</a></li>
                                                    <li><a href="#trade-history-and-tracker">Trade History &amp; Tracker</a></li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                <ul class="link-list-plain">
                                                    <li><a href="#trade-tracker-customization">Trade Tracker Customization</a></li>
                                                    <li><a href="#backtesting-and-forecasting">Backtesting &amp; Forecasting</a></li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                ...
                <div class="row g-gs" id="basic-setup">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                ...
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left" id="creating-account">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="<?php echo site_url('Free/register'); ?>">Register Account</a></li>
                                                </ul>
                                                <br>
                                                <br>
                ...
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left" id="logging-into-dashboard">
                ...
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left" id="kyc-verification">
                ...
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left" id="configuring-investor-profile">
                ...
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left" id="integrating-wallets">
                ...
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left" id="trade-history-and-tracker">
                ...
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left" id="trade-tracker-customization">
                ...
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left" id="backtesting-and-forecasting">
