    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            <div class="content-page">
                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                If there are no longer any available assets to be purchased because the initial release of coins were limited to purchase and that purchase limit has been reached, you can alternatively purchase
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row" id="asset-exchange"></div>
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h3 class="nk-block-title fw-normal">Asset Exchange</h3>
                                        <div class="nk-block-des">
                                            <p class="lead">
                                            </p>
                                        </div>
