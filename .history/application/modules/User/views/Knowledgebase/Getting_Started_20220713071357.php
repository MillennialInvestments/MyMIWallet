                                ...
                                <div class="card">
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <p class="lead fs-14px">  
                                                Once you have completed our KYC Verification Process, you will be granted full access to the resources and tools MyMI Wallet has to offer as long as you comply with our Terms & Agreement Pol
                                            </p>
                                            <p class="lead fs-14px">
                                                To learn more about our KYC Process and Requipments, as well as checking on the status of your KYC Verification, simply visit the links below:
                                                <ul class="list-group list-group-flush">
