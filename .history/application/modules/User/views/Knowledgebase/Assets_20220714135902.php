                                ...
                                <div class="card">
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <p class="lead fs-14px">    
                                                <strong>For Example:</strong> If you create 1,000,000 coins for an asset, and you wish to release 50% of those assets to the Private/Public Marketplace, only 500,000 will be available for pur                  
                                            </p>
                                            <p class="lead fs-14px">    
