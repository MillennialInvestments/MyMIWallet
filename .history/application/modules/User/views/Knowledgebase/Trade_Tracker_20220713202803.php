                    ...
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h3 class="nk-block-title fw-normal">What is the MyMI Trade Tracker?</h3>
                                        <div class="nk-block-des">
                                            <p class="lead">
                                                Contrary to belief, there are a number of traders that still track their trades utilzing pen and paper. Some investors use Microsoft Excel and other forms of 
                                            </p>
                                        </div>
                                    </div>
                                </div>
