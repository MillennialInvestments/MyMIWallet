...
$MyMIGold_TierOneCost                   = $MyMIGold_Value * $MyMIGold_TierO
    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            <div class="content-page">
                    ...
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h5 class="nk-block-title fw-normal pb-3">What is a MyMI Partner?</h5>
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">     
                                                We developed MyMI Partnerships to allow Individuals and Businesses to have the ability to access our Investment Accounting, Analytical and Exchange resources. 
                                                As we were developing the MyMI Partnerships, we envisioned providing individuals and businesses alike, being able to access the resources that we're developing and utilizing those resources in their daily activities. 
                                                Whether it's selling merchandise on a website as an individual, or expanding a business into new markets, Millennial Investments aimed to become a resource in all faucets.                             
                                            </p>
                                            <p class="lead fs-14px">
                                                By taking those possibilities into consideration, we developed the MyMI Partnership Program. 
                                                The MyMI Partnership Program was designed and continues to be developed to assist all use-cases in terms of financial invvestments, shared assets/revenue projects, and more. 
                                                Now all members have access to liquidity and financial backing like never before.             
                                            </p>
                                            <p class="lead fs-14px">
                ...
                <div class="row" id="registering-upgrading-to-a-partner"></div>
                <div class="row g-gs">
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h5 class="nk-block-title fw-normal pb-3">Registering/Upgrading to a Partner Membership</h5>
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">      
                                                To get started, if you're new to MyMI Wallet, you simply complete a MyMI Partnership Application (by clicking <a href="<?php echo site_url('Partner/register'); ?>">here!</a>). 
                                                If you're an existing member, you can simply upgrade your membership by visiting <a href="<?php echo site_url('/Subscriptions'); ?>">My Subscriptions</a> under <strong>My Account</strong>. 

                                            </p>
                                            <p class="lead fs-14px">
                                                If you are a new/existing customer, you can begin your MyMI Partnership today by visiting the link below: 
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="<?php echo site_url('Partner/register'); ?>">Partnership Registration</a></li>
                                                    <li class="list-group-item"><a href="<?php echo site_url('Subscriptions'); ?>">Upgrade to Partner</a></li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h5 class="nk-block-title fw-normal pb-3">More Details about our Partnership Program</h5>
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <p class="lead fs-14px">   
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><span><?php echo $MyMIGold_TierOneCost; ?></span><span><?php echo $MyMIGold_TierOne; ?> MyMI Gold</span></li>
                                                    <li class="list-group-item"><span><?php echo $MyMIGold_TierTwoCost; ?></span><span><?php echo $MyMIGold_TierTwo; ?> MyMI Gold</span></li>
                                                    <li class="list-group-item"><span><?php echo $MyMIGold_TierThreeCost; ?></span><span><?php echo $MyMIGold_TierThree; ?> MyMI Gold/span></li>
                                                    <li class="list-group-item"><span><?php echo $MyMIGold_TierFourCost; ?></span><span><?php echo $MyMIGold_TierFour; ?> MyMI Gold</span></li>
                                                    <li class="list-group-item"><span><?php echo $MyMIGold_TierFiveCost; ?></span><span><?php echo $MyMIGold_TierFive; ?> MyMI Gold</span></li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h5 class="nk-block-title fw-normal pb-3">Asset Distribution</h5>
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">            
                                                As you become more involved with MyMI Wallet and truly access the potential of our Asset Exchange, you will discover that the purchase of some assets could result in residual payments from Shared Revenue. 
                                                After gaining ownership to specific types of Assets, the creator of those assets will be giving the ability to share revenue stream earned from the investment of that asset pool and what the asset was created/designed to produce.                                                                
                                            </p>
                                            <p class="lead fs-14px">   
                                                In the event that you are recipient of Residual Income from an owned Asset, you will receive your Residual Payments creditted to your account in the form of MyMI Gold on the 15th of every month.
                                                <br><br><small>Please note that if you owe any MyMI Gold for Monthly Recurring Premium Features, your Residual Payments could be used to fill those balances.</small>                                                           
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h5 class="nk-block-title fw-normal pb-3">Asset Distribution Schedule</h5>
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">                           
                                            </p>
                                        </div>
                    ...
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h3 class="nk-block-title fw-normal">Payment History</h3>
                                        <div class="nk-block-des">
                                            <p class="lead">
                    ...
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h3 class="nk-block-title fw-normal">Customer Support</h3>
                                        <div class="nk-block-des">
                                            <p class="lead">
                                            </p>
                                        </div>
