    ...
    <div class="nk-content-inner">
        <div class="nk-content-body">
            <div class="content-page">
                ...
                <?php $this->load->view('User/Knowledgebase/includes/Partners/subheader'); ?>
                <?php $this->load->view('User/Knowledgebase/includes/Partners/full_content'); ?>
                <?php $this->load->view('User/Knowledgebase/includes/Partners/more_details'); ?>
