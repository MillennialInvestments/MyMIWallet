                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-2 text-center"><a class="btn btn-outline-primary" href="<?php echo site_url('Support'); ?>"><em class="icon ni ni-help"></em> Submit Ticket</a></div>           
                                                ...
                                                <div class="col-12 col-md-2 text-center"><a class="btn btn-outline-primary" href="<?php echo $discordPage; ?>"><i class="fa-brands fa-discord"></i> Discord</a></div>       
