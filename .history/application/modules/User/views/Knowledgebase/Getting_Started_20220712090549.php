                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a class="mb-3" href="<?php echo site_url('login'); ?>">Login Now!</a></li>
                                                </ul>
                                                <br>
                                                <br>
                                                View the following article for more details on account types.
                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a class="mb-3" href="#<?php //echo site_url('Free/register'); ?>">Check KYC Status</a></li>
                                                </ul>
                                                <br>
                                                <br>
                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a class="mb-3" href="#<?php //echo site_url('Free/register'); ?>">Updating Investor Profile</a></li>
                                                </ul>
                                                <br>
                                                <br>
                                                <!-- How KYC Will Be Conducted and Completion Requirements -->
                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a class="mb-3" href="#<?php //echo site_url('Free/register'); ?>">What are MyMI Wallet</a></li>
                                                </ul>                                                
                                                <br>
                                                <br>
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a class="mb-3" href="#<?php //echo site_url('Free/register'); ?>">How to Manually Track Trades</a></li>
                                                    <li class="list-group-item"><a class="mb-3" href="#<?php //echo site_url('Free/register'); ?>">How to Integrate Brokerage Accounts</a></li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                <br> 
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a class="mb-3" href="#<?php //echo site_url('login'); ?>">"What's With This Trade Tracker?"</a></li>
                                                </ul>
