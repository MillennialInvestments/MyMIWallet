                    ...
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h5 class="nk-block-title fw-normal pb-3">KYC Required Information (Individual)</h5>
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                If you ever wish to create <a href="#">MyMI Assets</a>, you will be required to upgrade to our <strong>Partnership Program</strong> and abide by 
                    ...
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h5 class="nk-block-title fw-normal pb-3">KYC Required Information (Corporate)</h5>
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                At minimum, we are required to obtain your <strong>Full Name</strong>, <strong>Date of Birth</strong>, <strong>Address</strong>, and <strong>Federal Certified Identification Number</strong> for our Basic Customer Identification Program. 
