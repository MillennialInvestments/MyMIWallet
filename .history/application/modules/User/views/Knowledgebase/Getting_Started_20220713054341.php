                            ...
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                Once you have completed the To gain access to your account and Investor Dashboard, visit <a href="<?php echo site_url('login'); ?>">https://www.mymiwallet.com/login</a>.<br> 
