                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-2 text-center"><a class="btn btn-outline-primary" href="<?php echo site_url('Support'); ?>"><em class="icon ni ni-help"></em> Submit A Ticket</a></div>           
                                                <div class="col-12 col-md-2 text-center"><a class="btn btn-outline-primary" href="<?php echo $facebookPage; ?>"><em class="icon ni ni-facebook-circle"></em> Facebook</a></div>           
                                                <div class="col-12 col-md-2 text-center"><a class="btn btn-outline-primary" href="<?php echo $twitterPage; ?>"><em class="icon ni ni-twitter"></em> Twitter</a></div>                  
                                                <div class="col-12 col-md-2 text-center"><a class="btn btn-outline-primary" href="<?php echo $discordPage; ?>"><em class="icon ni ni-discord"></em> Discord</a></div>       
                                                <div class="col-12 col-md-2 text-center"><a class="btn btn-outline-primary" href="<?php echo $stocktwitsPage; ?>"><em class="icon ni ni-chat"></em> Stocktwits</a></div>        
                                            </div>
                                        </div>
                                    </div>
                                </div>
