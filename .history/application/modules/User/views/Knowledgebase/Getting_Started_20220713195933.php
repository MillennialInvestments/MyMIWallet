                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <p class="lead fs-14px">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="<?php echo site_url('Knowledge-Base/KYC-Verification'); ?>">KYC Process &amp; Requirements</a></li>
                                    ...
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="<?php echo site_url('Knowledge-Base/Integrating-Wallets'); ?>">What are MyMI Wallet</a></li>
                                                </ul>       
                                            </p>
                                            <p class="lead fs-14px">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="<?php echo site_url('Knowledge-Base/Integrating-Wallets#individual-required-information'); ?>">How to Manually Track Trades</a></li>
                                                    <li class="list-group-item"><a href="<?php echo site_url('Knowledge-Base/Integrating-Wallets'); ?>">How to Integrate Brokerage Accounts</a></li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
