                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <p class="lead fs-14px">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="#<?php //echo site_url('Knowledge-Base/KYC-Requirements'); ?>">Completing KYC Verification</a></li>
                                                    <li class="list-group-item"><a href="#<?php //echo site_url('Support/Check-KYC-Verification'); ?>">KYC Documentation Requirements</a></li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="nk-block-head nk-block-head-lg wide-md pb-0">
                            <div class="nk-block-head-content">
                                <div class="card">
                                    <div class="card-inner text-left">
                                        <h5 class="nk-block-title fw-normal">Step 1: Completing KYC Verification</h5>
                                        <div class="nk-block-des">
                                            <p class="lead fs-14px">
                                                <ul class="link-list-plain">
                                                    <li><a href="#">Getting Started with KYC Verification</a></li>
                                                    <li><a href="#">Uploading Additional KYC Documentation</a></li>
                                                    <li><a href="#">Process of Verification</a></li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-inner text-left">
                                        ...
                                        <div class="nk-block-des">
                                            ...
                                            <p class="lead fs-14px">
                                                To learn more about our KYC Process and Requipments, as well as checking on the status of your KYC Verification, simply review the links below:
                                                <ul class="list-group list-group-flush">
