									...
									<div id="tisker-list" hidden>
										<?php
                                            ...
                                            foreach ($getSym as $ticker) {
                                                echo '{"id":"' . $ticker['id'] . '","text":"'  . $ticker['symbol'] . '","tag":"' . $ticker['type'] . '"}';
                                                if (next($copy)) {
									...
									<div id="wallet-list" hidden>
										<?php
                                            ...
                                            foreach ($getWallets as $wallet) {
                                                echo '{"id":"' . $wallet['id'] . '","text":"'  . $wallet['nickname'] . '","tag":"' . $wallet['broker'] . '"}';
                                                if (next($walletCopy)) {
                                                    echo ',';
                                                }
                                            }
