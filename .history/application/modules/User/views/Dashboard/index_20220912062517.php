...
if ($activeInvestmentPercent > 0) {
    ...
    $activeInvestmentGains                      = $activeInvestmentPercent;
    $activeInvestGainsClassA                    = 'change up text-success';
    $activeInvestGainsClassB                    = 'icon ni ni-arrow-long-dp';
} else {
    $activeInvestmentGains                      = $activeInvestmentPercent;
    $activeInvestGainsClassA                    = '';
    $activeInvestGainsClassB                    = '';
}
$activeTotalTrades                              = '0';
                                ...
                                <div class="invest-ov-details">
                                    <div class="invest-ov-info">
                                        <div class="amount">
                                            ...
                                            <span class="<?php echo $activeInvestGainsClassA; ?>"><em class="<?php echo $activeInvestGainsClassB; ?>"></em><?php echo $activeInvestmentGains; ?></span>
                                        </div>
                        ...
                        <div class="tab-pane" id="thisyear">
                            <div class="invest-ov gy-2">
                                ...
                                <div class="invest-ov-details">
                                    ...
                                    <div class="invest-ov-stats">
                                        <div>
                                            <span class="amount">96</span><span class="change up text-danger"><em class="icon ni ni-arrow-long-up"></em>1.93%</span>
                                        </div>
