            ...
            <div class="card-inner card-inner-lg pt-3">
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tabItem5">
                        <?php $this->load->view('User/Dashboard/Investor_Profile/Expense_Accounts', $viewData); ?>
                    </div>  
                    <!-- Connected Accounts -->
                ...
                <div class="card-inner-group" data-simplebar>
                    ...
                    <div class="card-inner p-0">
                        <ul class="nav link-list-menu border border-light round m-0 flex-column">
                            ...
                            <li><a data-bs-toggle="tab" href="#tabItem5"><em class="icon ni ni-wallet-out"></em><span>Expense Accounts</span></a></li>
