...
$activeInvestmentGains                          = '0.00';
if ($activeInvestmentGains > 0) {

} elseif ($activeInvestmentGains < 0) {}
$activeTotalTrades                              = '0';
                                ...
                                <div class="invest-ov-details">
                                    <div class="invest-ov-info">
                                        <div class="amount">
                                            ...
                                            <span class="change up text-danger"><em class="icon ni ni-arrow-long-up"></em><?php echo $activeInvestmentGains; ?></span>
                                        </div>
