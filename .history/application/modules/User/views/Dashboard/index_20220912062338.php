...
if ($activeInvestmentPercent > 0) {
    ...
    $activeInvestGainsClassA                    = 'change up text-succ';
                                ...
                                <div class="invest-ov-details">
                                    <div class="invest-ov-info">
                                        <div class="amount">
                                            ...
                                            <span class="<?php echo $activeInvestGainsClassA; ?>"><em class="icon ni ni-arrow-long-up"></em><?php echo $activeInvestmentGains; ?></span>
                                        </div>
