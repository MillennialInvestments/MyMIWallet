...
if ($activeInvestmentPercent > 0) {
    ...
    $activeInvestmentGains                      = $activeInvestmentPercent . '%';
    $activeInvestGainsClassA                    = 'change text-muted text-dark';
                                ...
                                <div class="invest-ov-details">
                                    <div class="invest-ov-info">
                                        <div class="amount">
                                            ...
                                            <small class="fs-14px">(<span class="<?php echo $activeInvestGainsClassA; ?>"><em class="<?php echo $activeInvestGainsClassB; ?>"></em><?php echo $activeInvestmentGains; ?></span>)</small>
                                        </div>
