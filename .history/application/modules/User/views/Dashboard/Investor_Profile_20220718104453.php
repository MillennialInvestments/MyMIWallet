                ...
                <div class="card-inner-group" data-simplebar>
                    ...
                    <div class="card-inner p-0">
                        <ul class="nav link-list-menu border border-light round m-0">
                            ...
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tabItem3"><em class="icon ni ni-activity-round-fill"></em><span>Activities</span></a></li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tabItem2"><em class="icon ni ni-bell-fill"></em><span>Transactions</span></a></li>
