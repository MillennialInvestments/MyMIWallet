                ...
                <div class="card-inner-group" data-simplebar>
                    ...
                    <div class="card-inner p-0">
                        <ul class="link-list-menu">
                            ...
                            <li><a data-bs-toggle="tab" href="#tabItem3"><em class="icon ni ni-activity-round-fill"></em><span>Assets</span></a></li>
                            <li><a data-bs-toggle="tab" href="#tabItem4"><em class="icon ni ni-grid-add-fill-c"></em><span>Connected Accounts</span></a></li>
                            <li><a data-bs-toggle="tab" href="#tabItem5"><em class="icon ni ni-lock-alt-fill"></em><span>Notifications</span></a></li>
