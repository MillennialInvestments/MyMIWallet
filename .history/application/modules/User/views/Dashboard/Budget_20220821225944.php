                    ...
                    <div class="card-inner">
                        <div class="nk-wg-action">
                            <div class="nk-wg-action-content">
                                ...
                                <p>We have a Total of <a href="<?php echo site_url('Management/Assets/Transactions'); ?>"><strong><?php //echo $totalTransactions; ?> Su</strong></a>, <a href="<?php echo site_url('Management/Assets/Transactions'); ?>"><strong><?php //echo $totalTransTotals; ?> Total Spend</strong></a>, and <a href="<?php echo site_url('Management/Assets/Transactions'); ?>"><strong><?php //echo $totalTransFees; ?> Total</strong></a> in Transactional Fees.</p>
                            </div>
                            <a href="<?php echo site_url('Management/Assets/Transactions'); ?>" class="btn btn-icon btn-trigger me-n2"><em class="icon ni ni-forward-ios"></em></a>
                        </div>
                    </div><!-- .card-inner -->
