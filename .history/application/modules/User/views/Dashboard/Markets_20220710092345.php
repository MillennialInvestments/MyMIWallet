...
if ($marketType === 'US-Markets') {
    ...
    $marketView         = 'User/Dashboard/index/US_Market_Overview', $dashboardData); 
} elseif ($marketType === 'Additional-Markets') {
    $marketTitle        = 'Additional US Markets';
    $marketView         = 'User/Dashboard/index/US_Additional_Overview', $dashboardData); 
} elseif ($marketType === 'International-Markets') {
    $marketTitle        = 'International Markets';
    $marketView         = 'User/Dashboard/index/International_Market_Overview', $dashboardData); 
} elseif ($marketType === 'Crypto-Markets') {
    $marketTitle        = 'Crypto Markets';
    $marketView         = 'User/Dashboard/index/Crypto_Market_Overview', $dashboardData); 
} elseif ($marketType === 'MyMI-Markets') {
    $marketTitle        = 'MyMI Markets';
    $marketView         = 'User/Dashboard/index/MyMI_Market_Overview', $dashboardData); 
}
$dashboardData          = array(
