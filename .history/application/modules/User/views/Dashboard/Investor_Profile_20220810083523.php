                ...
                <div class="card-inner-group" data-simplebar>
                    ...
                    <div class="card-inner">
                        <div class="user-account-info py-0">
                            ...
                            <div class="user-balance-sub">Locked <span><?php echo $MyMIGCoinSum . ' <span class="currency currency-usd">MyMI Gold</span>'; <span class="currency currency-btc">BTC</span></span></div>
                        </div>
                    </div><!-- .card-inner -->
