                            ...
                            <div class="invest-ov gy-2">
                                ...
                                <div class="invest-ov-details">
                                    <div class="invest-ov-info">
                                        <div class="amount">
                                            <?php echo $activeInvestmentTotals; ?> <span class="currency currency-usd">USD</span><span class="change up text-danger"><em class="icon ni ni-arrow-long-up"></em>1.93%</span>
                                        </div>
