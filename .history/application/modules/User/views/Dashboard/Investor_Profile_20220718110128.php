            ...
            <div class="card-aside card-aside-left user-aside toggle-slide toggle-slide-left toggle-break-lg" data-toggle-body="true" data-content="userAside" data-toggle-screen="lg" data-toggle-overlay="true">
                <div class="card-inner-group" data-simplebar>
                    ...
                    <div class="card-inner p-0">
                        <ul class="nav link-list-plain border border-light round m-0">
                            <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#tabItem1"><em class="icon ni ni-user-fill-c"></em><span>Personal Infomation</span></a></li><br>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tabItem2"><em class="icon ni ni-activity-round-fill"></em><span>Activities</span></a></li><br>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tabItem3"><em class="icon ni ni-activity-round-fill"></em><span>Assets</span></a></li><br>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tabItem4"><em class="icon ni ni-grid-add-fill-c"></em><span>Connected Accounts</span></a></li><br>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tabItem5"><em class="icon ni ni-lock-alt-fill"></em><span>Notifications</span></a></li><br>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tabItem6"><em class="icon ni ni-lock-alt-fill"></em><span>Security Settings</span></a></li><br>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tabItem7"><em class="icon ni ni-bell-fill"></em><span>Transactions</span></a></li><br>
                        </ul>
                    </div><!-- .card-inner -->
