                    ...
                    <div class="tab-content mt-0">
                        <div class="tab-pane active" id="overview">
                            ...
                            <div class="invest-ov gy-2">
                                ...
                                <div class="invest-ov-details">
                                    <div class="invest-ov-info">
                                        <div class="amount"><?php echo $activeMonthlyInvestments; ?> <span class="currency currency-usd">USD</span><span class="change down text-danger"><em class="icon ni ni-arrow-long-down"></em>1.93%</span>
                                        </div>
