                ...
                <div class="card-inner-group" data-simplebar>
                    ...
                    <div class="card-inner p-0">
                        <ul class="nav link-list-menu border border-light round m-0">
                            ...
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tabItem2"><em class="icon ni ni-activity-round-fill"></em><span>Assets</span></a></li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tabItem5"><em class="icon ni ni-grid-add-fill-c"></em><span>Connected Accounts</span></a></li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tabItem4"><em class="icon ni ni-lock-alt-fill"></em><span>Notifications</span></a></li>
                            ...
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tabItem3"><em class="icon ni ni-bell-fill"></em><span>Transactions</span></a></li>
                        </ul>
                    </div><!-- .card-inner -->
