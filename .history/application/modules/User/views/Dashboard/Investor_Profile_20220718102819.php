                ...
                <div class="card-inner-group" data-simplebar>
                    ...
                    <div class="card-inner p-0">
                        <ul class="link-list-menu nav nav-tabs">
                            <li class="nav-item"><a class="nav-liactive" data-bs-toggle="tab" href="#tabItem1"><em class="icon ni ni-user-fill-c"></em><span>Personal Infomation</span></a></li>
                            <li><a data-bs-toggle="tab" href="#tabItem2"><em class="icon ni ni-bell-fill"></em><span>Notifications</span></a></li>
                            <li><a data-bs-toggle="tab" href="#tabItem3"><em class="icon ni ni-activity-round-fill"></em><span>Account Activity</span></a></li>
                            <li><a data-bs-toggle="tab" href="#tabItem4"><em class="icon ni ni-lock-alt-fill"></em><span>Security Settings</span></a></li>
                            <li><a data-bs-toggle="tab" href="#tabItem5"><em class="icon ni ni-grid-add-fill-c"></em><span>Connected with Social</span></a></li>
                        </ul>
                    </div><!-- .card-inner -->
