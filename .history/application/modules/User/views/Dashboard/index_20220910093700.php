...
$dashboardData							        = array(
    ...
    'totalFinancialBalances'                    => $totalFinancialBalances,
    'totalInvestmentBalance'                    => $totalInvestmentBalancedss,  
);
?>   
<style>
.tranx-amount .number {
...
<div class="nk-block">
    <div class="row g-gs">
        ...
        <div class="col-md-4">
            <?php $this->load->view('User/Dashboard/index-new/total_expenses', $dashboa)
        </div><!-- .col -->
