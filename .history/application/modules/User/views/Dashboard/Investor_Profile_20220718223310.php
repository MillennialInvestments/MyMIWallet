        ...
        <div class="card-aside-wrap">
            <div class="card-inner card-inner-lg">
                <div class="tab-content">
                    ...
                    <div class="tab-paneactive" id="tabItem1"> 
                        <?php $this->load->view('User/Dashboard/Investor_Profile/Personal_Information'); ?>
                    </div>   
                    <!-- User Activities -->
                    <div class="tab-pane" id="tabItem2">
                        <?php $this->load->view('User/Dashboard/Investor_Profile/Activity'); ?>
                    </div>
                    <!-- Assets -->
                    <div class="tab-pane" id="tabItem3">
                        <?php $this->load->view('User/Dashboard/Investor_Profile/Assets'); ?>
                    </div>
                    <!-- Connected Accounts -->
                    <div class="tab-pane" id="tabItem4">
                        <?php $this->load->view('User/Dashboard/Investor_Profile/Connected_Accounts'); ?>
                    </div>
                    <!-- Notification Settings -->
                    <div class="tab-pane" id="tabItem5">
                        <?php $this->load->view('User/Dashboard/Investor_Profile/Notifications'); ?>
                    </div>
                    <!-- Security Settings -->
                    <div class="tab-pane" id="tabItem6">
                        <?php $this->load->view('User/Dashboard/Investor_Profile/Security_Settings'); ?>
                    </div>
                    <!-- Transactions -->
