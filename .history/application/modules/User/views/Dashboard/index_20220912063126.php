                                ...
                                <div class="invest-ov-details">
                                    <div class="invest-ov-info">
                                        <div class="amount">
                                            ...
                                            <small class="fs-14px text-m>(<span class="<?php echo $activeInvestGainsClassA; ?>"><em class="<?php echo $activeInvestGainsClassB; ?>"></em><?php echo $activeInvestmentGains; ?></span>)</small>
                                        </div>
