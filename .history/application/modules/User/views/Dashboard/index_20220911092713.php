                    ...
                    <div class="timeline">
                        ...
                        <ul class="timeline-list">
                            ...
                            <li class="timeline-item">
                                ...
                                <div class="timeline-date">' . $announcement['day'] . ' ' . date("d-m-Y", strtotime($announcement['month'])) . ' <em class="icon ni ni-alarm-alt"></em></div>
                                <div class="timeline-data">
                                    <h6 class="timeline-title">' . $announcement['topic'] . '</h6>
                                    <div class="timeline-des">
                                        <p style="width: 50%; overflow: hidden; text-overflow: ellipsis;">' . $announcement['details'] . '</p>
