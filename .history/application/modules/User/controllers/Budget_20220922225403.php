    ...
    {
        {
            ...
            if ($this->form_validation->run() === false) {
                ...
                if ($this->investor_model->add_investor_profile($created_by, $created_by_date, $unix_timestamp, $month, $day, $year, $time, $status, $account_type, $source_type, $intervals, $name, $amunt, $designated,)) {
