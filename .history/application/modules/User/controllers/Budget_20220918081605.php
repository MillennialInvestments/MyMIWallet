...
class Budget extends Admin_Controller
{
    ...
    {
        $pageType = 'Standard';
        $pageName = 'User_Budget_Type_Overview';
        
        $this->set_current_user();
        
        Template::set('pageType', $pageType);
        Template::set('pageName', $pageName);
        Template::set_view('User/Budget/Type_Overview'); 
        Template::render();
    }
    ...
    public function Add_Account()
    {
        ...
        Template::set('pageType', $pageType);
        Template::set('pageName', $pageName);
        Template::set_view('User/Budget/Add_Account'); 
        Template::render();
    }
    public function Profile_Manager()
    {
        ...
        $this->load->view('User/Profile_Manager');
    }
