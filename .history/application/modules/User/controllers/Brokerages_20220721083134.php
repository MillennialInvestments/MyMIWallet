...
class Stock extends Admin_Controller
{
    ...
    public function TD_Ameritrade($id, $code)
    {
        $pageType = 'Standard';
        $pageName = 'User_Dashboard';
        $this->set_current_user();
        ...
        // Set POST Fields for TD Ameritrade Refresh Token -> 90-Day Authorization Code Transformation
        ...
        // Set Access Code 90-Day Authorization Parameters
        ...
        // Initiate 90-Day Access Code Gener
