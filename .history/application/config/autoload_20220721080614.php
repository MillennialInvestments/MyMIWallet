...
*/
$autoload['libraries'] = array('users/Auth', 'database', 'email', 'emailer/emailer', 'form_validation', 'MyMIAnalytics', 'MyMIExchange', 'MyMICoin', 'MyMIGold', 'MyMIWallet', 'MyMIUser', 'pagination', 'table', 'upload', 'user_agent', 'zip');
