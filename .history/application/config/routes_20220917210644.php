...
// Route::any('Budget/Income', 'User/Dashboard/Budget_Type_Overview');
// Route::any('Budget/Income/Add', 'User/Dashboard/Budget/Add_Account');
// Route::any('Budget/Expense', 'User/Dashboard/Budget_Type_Overview');
// Route::any('Budget/Expense/Add', 'User/Dashboard/Budget/Add_Account');

// User - Budget
Route::any('Budget', 'User/Budget');
Route::any('Budget/Income', 'User/Budget_Type_Overview');
Route::any('Budget/Income/Add', 'User/Budget/Add_Account');
Route::any('Budget/Expense', 'User/Budget_Type_Overview');
Route::any('Budget/Expense/Add', 'User/Dashboard/Budget/Add_Account');
