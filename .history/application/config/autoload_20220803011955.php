...
*/
$autoload['libraries'] = array('users/Auth', 'database', 'email', 'emailer/emailer', 'form_validation', 'MyMIAnalytics', 'MyMICoin', 'MyMIExchange', 'MyMIGold', 'MyMIGold', 'MyMIMarketing', 'MyMIWallet', 'MyMIUser', 'user_agent');
