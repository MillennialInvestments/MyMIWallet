        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
            <div class="g pe-md-4">
                <div class="w-max-600px">
                    ...
                    <p class="lead">We're thrilled to welcome you to our new Automated Application to manage your future investments. If you are interest to check demo please contact us.</p>
                </div>
            </div>
