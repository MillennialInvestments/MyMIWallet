                ...
                <div class="intro-banner-wrap">
                    <div class="intro-banner-inner text-center">
                        ...
                        <ul class="intro-action-group">
                            <li><a href="<?php echo site_url('/Dashboard')$registrationURL; ?>" class="btn btn-lg btn-primary" target="_blank">Register Now</a></li>
                            <li><a href="<?php echo site_url('/Dashboard'); ?>" class="link-to btn btn-lg btn-danger">MyMI Dashboard</a></li>
                        </ul>
