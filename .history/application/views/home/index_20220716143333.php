        ...
        <div class="row justify-content-center">
            <div class="col-xl-10">
                <div class="intro-overview-list">
                    ...
                    <div class="intro-overview-item"><span class="intro-ov-number text-purpl"><?php echo $totalWalletsCreated; ?></span><span class="intro-ov-title text-purple">MyMI Wallets</span></div>
                    <div class="intro-overview-item"><span class="intro-ov-number"><?php echoe $totalTradesTracked; ?></span><span class="intro-ov-title">Total Trades</span></div>
