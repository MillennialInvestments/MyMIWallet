        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="intro-section-title">
                    ...
                    <h2 class="intro-heading-lead">Investment Accounting <span class="break-mb">&</span> Analytical Statistics</h2>
                    <div class="intro-section-desc">
                        <p>An overview of <strong class="text-soft">MyMI Wallet</strong> – is fully clean and premium designed admin template which included beautiful hand-crafted components & elements. MyMI Wallet completely focusing on <strong>conceptual base apps or dashboard</strong>, as it’s equipped with pre-built screens as well.</p>
                    </div>
                </div>
            </div>
        </div>
