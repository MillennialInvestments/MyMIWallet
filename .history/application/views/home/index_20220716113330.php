                ...
                <div id="preview" class="intro-section intro-apps text-center text-white bg-primary-dark">
                    <div class="container">
                        ...
                        <div class="row intro-apps-list justify-content-center">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo5/crypto/index.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="/images/landing/demo-buysell.jpg" srcset="/images/landing/demo-buysell2x.jpg 2x" alt=""></a>
                                    <div class="intro-apps-desc">
