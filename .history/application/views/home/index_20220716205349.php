        ...
        <div class="row justify-content-center">
            <div class="col-lg-9 col-xl-7">
                <div class="intro-section-title text-center">
                    ...
                    <div class="intro-section-desc">
                        <p>Customize your Investor and Partner Memberships with our super user-friendly dashboard Create your web application amazing and more professional with this super user-friendly dashboard template. DashLite comes with all essential features that always you or your developers looking for. </p>
                    </div>
                </div>
            </div>
        </div>
