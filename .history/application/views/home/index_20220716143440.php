        ...
        <div class="row justify-content-center">
            <div class="col-xl-10">
                <div class="intro-overview-list">
                    ...
                    <div class="intro-overview-item"><span class="intro-ov-number text-blue"><?php echo $totalWalletsCreated; ?></span><span class="intro-ov-title text-blue">MyMI Wallets</span></div>
                    <div class="intro-overview-item"><span class="intro-ov-number text-blue"><?php echo $totalTradesTracked; ?></span><span class="intro-ov-title text-blue">Total Trades</span></div>
                    <div class="intro-overview-item"><span class="intro-ov-number text-blue"><?php echo $totalActivePartners; ?></span><span class="intro-ov-title text-blue">MyMI Partners</span></div>
                    <div class="intro-overview-item"><span class="intro-ov-number text-blue"><?php echo $totalApprovedAssets; ?></span><span class="intro-ov-title text-blue">MyMI Assets</span></div>
                </div>
            </div>
        </div>
