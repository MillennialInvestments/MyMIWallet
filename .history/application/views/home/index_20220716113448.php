                        ...
                        <div class="intro-preview-list row justify-content-center">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/landing/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-light"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/main-landing.'); ?>" srcset="/images/landing/main-landing2x.jpg 2x" alt="DashLite Landing Page"></div>
                                    <div class="intro-preview-name">
