...
$totalApprovedAssets    = $_SESSION['reporting']['totalWalletsCreated']; 
?>
<style>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-10">
                <div class="intro-overview-list">
                    <div class="intro-overview-item highlight"><span class="intro-ov-number">11+</span><span class="intro-ov-title">Investors</span></div>
                    <div class="intro-overview-item"><span class="intro-ov-number text-purple">7+</span><span class="intro-ov-title text-purple">MyMI Wallets</span></div>
                    <div class="intro-overview-item"><span class="intro-ov-number">150+</span><span class="intro-ov-title">Total Trades</span></div>
