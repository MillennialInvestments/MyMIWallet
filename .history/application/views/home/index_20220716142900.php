        ...
        <div class="row justify-content-center">
            <div class="col-xl-10">
                <div class="intro-overview-list">
                    ...
                    <div class="intro-overview-item"><span class="intro-ov-number text-purple"><?php echo $totalWalletsCrea; ?></span><span class="intro-ov-title text-purple">MyMI Wallets</span></div>
