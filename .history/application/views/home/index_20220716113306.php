                        ...
                        <div class="intro-preview-list row justify-content-center">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/demo7/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-success"><img src="/images/landing/layout-7d.jpg" srcset="/images/landing/layout-7d2x.jpg 2x" alt="DashLite Dashboard"></div>
                                    <div class="intro-preview-name">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/demo8/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-cyan"><img src="/images/landing/layout-8d.jpg" srcset="/images/landing/layout-8d2x.jpg 2x" alt="DashLite Dashboard"></div>
                                    <div class="intro-preview-name">
