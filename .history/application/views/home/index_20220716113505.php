                        ...
                        <div class="intro-preview-list row justify-content-center">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/demo2/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-pink"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/layout-2d.'); ?>" srcset="/images/landing/layout-2d2x.jpg 2x" alt="DashLite Dashboard"></div>
                                    <div class="intro-preview-name">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/demo3/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-teal"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/layout-3d.'); ?>" srcset="/images/landing/layout-3d2x.jpg 2x" alt="DashLite Dashboard"></div>
                                    <div class="intro-preview-name">
