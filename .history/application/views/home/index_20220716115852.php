                    ...
                    <div class="intro-banner-inner text-center">
                        <div class="intro-banner-desc">
                            ...
                            <p class="text-light">
                                ...
                                <strong class="text-white">MyMI Wallet</strong> comes with a variety of <a href="">Premium Features</a>, necessary to provide Inv <strong class="text-primary">Asset Marketplace & Exchanges</strong> that helps you to create your own <a href="">Digital Assets</a> to sell to intereseted potential investors.</p>
                        </div>
