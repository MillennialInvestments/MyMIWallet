...
$totalTradesTracked    = $_SESSION['reporting']['totalApprovedAssets']; 
?>
<style>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-10">
                <div class="intro-overview-list">
                    <div class="intro-overview-item highlight"><span class="intro-ov-number"><?php echo $totalActiveUsers; ?>+</span><span class="intro-ov-title">Investors</span></div>
                    <div class="intro-overview-item"><span class="intro-ov-number text-purple"><?php echo $totalWalletsCreated; ?></span><span class="intro-ov-title text-purple">MyMI Wallets</span></div>
                    <div class="intro-overview-item"><span class="intro-ov-number"><?php echo $totalActiveUsers; ?></span><span class="intro-ov-title">Total Trades</span></div>
                    <div class="intro-overview-item"><span class="intro-ov-number">25+</span><span class="intro-ov-title">MyMI Partners</span></div>
                    <div class="intro-overview-item"><span class="intro-ov-number">60+</span><span class="intro-ov-title">MyMI Assets</span></div>
                </div>
            </div>
        </div>
