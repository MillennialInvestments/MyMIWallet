                        ...
                        <div class="intro-preview-list row justify-content-center">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/demo8/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-cyan"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/layout-8d.'); ?>" srcset="/images/landing/layout-8d2x.jpg 2x" alt="DashLite Dashboard"></div>
                                    <div class="intro-preview-name">
