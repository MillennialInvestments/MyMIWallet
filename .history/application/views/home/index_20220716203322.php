            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="intro-section-title">
                    ...
                    <div class="intro-section-desc">
                        <p>An overview of <strong class="text-soft">MyMI Wallet</strong> – capture all of your financial data in one place, customize your analytics, and optimize your investment decisions. Utilize our Asset Marke
                        </p>
