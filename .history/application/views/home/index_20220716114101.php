                                ...
                                <div class="intro-banner-wrap">
                                    <div class="intro-banner-inner text-center">
                                        <div class="intro-banner-desc">
                                            ...
                                            <h1 class="title text-white">DashLite Dashboard <span class="version">v3.0.3</span> </h1>
                                            <p class="text-light">A powerful admin dashboard template that especially build for developers and programmers. <strong class="text-white">DashLite</strong> comes with all kind of components, necessary elements and pre-build pages including exclusive <strong class="text-primary">conceptual apps screen</strong> that helps you to create your web apps or application faster.</p>
                                        </div>
                                        <ul class="intro-action-group">
                                            <li><a href="https://1.envato.market/e0y3g" class="btn btn-lg btn-primary" target="_blank">Get DashLite Now</a></li>
                                            <li><a href="#preview" class="link-to btn btn-lg btn-danger">Check Out Demo</a></li>
                                        </ul>
                                        <div class="intro-small-foot pt-2"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/made-with.png" srcset="/images/landing/made-with2x.png 2x" alt="Made with"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-8 col-xl-7">
                                <div class="intro-section-title">
                                    <span class="overline-title intro-section-subtitle">Dashlite Overview</span>
                                    <h2 class="intro-heading-lead">Conceptual Apps <span class="break-mb">&</span> Premium Theme</h2>
                                    <div class="intro-section-desc">
                                        <p>An overview of <strong class="text-soft">DashLite</strong> – is fully clean and premium designed admin template which included beautiful hand-crafted components & elements. DashLite completely focusing on <strong>conceptual base apps or dashboard</strong>, as it’s equipped with pre-built screens as well.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-xl-10">
                                <div class="intro-overview-list">
                                    <div class="intro-overview-item highlight"><span class="intro-ov-number">11+</span><span class="intro-ov-title">Use-Case App<br>Concept</span></div>
                                    <div class="intro-overview-item"><span class="intro-ov-number text-purple">7+</span><span class="intro-ov-title text-purple">Dashboard <br> Layout</span></div>
                                    <div class="intro-overview-item"><span class="intro-ov-number">150+</span><span class="intro-ov-title">Pre-built <br> Screens</span></div>
                                    <div class="intro-overview-item"><span class="intro-ov-number">25+</span><span class="intro-ov-title">Eye-Catching <br> Components</span></div>
                                    <div class="intro-overview-item"><span class="intro-ov-number">60+</span><span class="intro-ov-title">Handmade <br> SVG Icon</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="intro-overview-action">
                            <ul>
                                <li><a href="#preview" class="link-to btn btn-lg btn-secondary">Use-Case Concept</a></li>
                                <li><a href="#intro-layout" class="link-to btn btn-lg btn-round btn-primary">View Demo Layouts</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row intro-apps-list justify-content-center">
                            <div class="col-lg-4 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo2/ecommerce/index.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="<?php echo base_url('assets/images/Dashlite-Examples/landing/demo-ecommerce.jpg'); ?>" srcset="/images/landing/demo-ecommerce2x.jpg 2x" alt=""></a>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo4/subscription/index.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="<?php echo base_url('assets/images/Dashlite-Examples/landing/demo-subscription.jpg'); ?>" srcset="/images/landing/demo-subscription2x.jpg 2x" alt=""></a>
                                    <div class="intro-apps-desc">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo5/crypto/index.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="<?php echo base_url('assets/images/Dashlite-Examples/landing/demo-buysell.jpg'); ?>" srcset="/images/landing/demo-buysell2x.jpg 2x" alt=""></a>
                                    <div class="intro-apps-desc">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo6/invest/index.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="<?php echo base_url('assets/images/Dashlite-Examples/landing/demo-invest.jpg'); ?>" srcset="/images/landing/demo-invest2x.jpg 2x" alt=""></a>
                                    <div class="intro-apps-desc">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo2/lms/index.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="<?php echo base_url('assets/images/Dashlite-Examples/landing/demo-lms.jpg'); ?>" srcset="/images/landing/demo-lms2x.jpg 2x" alt=""></a>
                                    <div class="intro-apps-desc">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo1/crm/index.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="<?php echo base_url('assets/images/Dashlite-Examples/landing/demo-crm.jpg'); ?>" srcset="/images/landing/demo-crm2x.jpg 2x" alt=""></a>
                                    <div class="intro-apps-desc">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo7/hospital/index.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="<?php echo base_url('assets/images/Dashlite-Examples/landing/demo-hospital.jpg'); ?>" srcset="/images/landing/demo-hospital2x.jpg 2x" alt=""></a>
                                    <div class="intro-apps-desc">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo1/hotel/index.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="<?php echo base_url('assets/images/Dashlite-Examples/landing/demo-hotel.jpg'); ?>" srcset="/images/landing/demo-hotel2x.jpg 2x" alt=""></a>
                                    <div class="intro-apps-desc">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo3/cms/index.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="<?php echo base_url('assets/images/Dashlite-Examples/landing/demo-cms.jpg'); ?>" srcset="/images/landing/demo-cms2x.jpg 2x" alt=""></a>
                                    <div class="intro-apps-desc">
                        ...
                        <div class="row intro-apps-list is-compact justify-content-center">
                            <div class="col-lg-3 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo3/apps/file-manager.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="<?php echo base_url('assets/images/Dashlite-Examples/landing/demo-file-manager.jpg'); ?>" srcset="/images/landing/demo-file-manager2x.jpg 2x" alt=""></a>
                                    <div class="intro-apps-desc">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo3/apps/chats.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="<?php echo base_url('assets/images/Dashlite-Examples/landing/demo-chats.jpg'); ?>" srcset="/images/landing/demo-chats2x.jpg 2x" alt=""></a>
                                    <div class="intro-apps-desc">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo3/apps/messages.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="<?php echo base_url('assets/images/Dashlite-Examples/landing/demo-messages.jpg'); ?>" srcset="/images/landing/demo-messages2x.jpg 2x" alt=""></a>
                                    <div class="intro-apps-desc">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="intro-apps-item">
                                    <a href="https://dashlite.net/demo3/apps/mailbox.html" class="intro-apps-img" target="_blank"><img class="intro-apps-default" src="<?php echo base_url('assets/images/Dashlite-Examples/landing/demo-inbox.jpg'); ?>" srcset="/images/landing/demo-inbox2x.jpg 2x" alt=""></a>
                                    <div class="intro-apps-desc">
                        ...
                        <div class="intro-preview-list row justify-content-center">
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/demo1/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-purple"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/layout-1d.jpg'); ?>" srcset="/images/landing/layout-1d2x.jpg 2x" alt="DashLite Dashboard"></div>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/demo2/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-pink"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/layout-2d.jpg'); ?>" srcset="/images/landing/layout-2d2x.jpg 2x" alt="DashLite Dashboard"></div>
                                    <div class="intro-preview-name">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/demo3/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-teal"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/layout-3d.jpg'); ?>" srcset="/images/landing/layout-3d2x.jpg 2x" alt="DashLite Dashboard"></div>
                                    <div class="intro-preview-name">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/demo4/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-danger"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/layout-4d.jpg'); ?>" srcset="/images/landing/layout-4d2x.jpg 2x" alt="DashLite Dashboard"></div>
                                    <div class="intro-preview-name">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/demo5/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-warning"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/layout-5d.jpg'); ?>" srcset="/images/landing/layout-5d2x.jpg 2x" alt="DashLite Dashboard"></div>
                                    <div class="intro-preview-name">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/demo6/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-blue"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/layout-6d.jpg'); ?>" srcset="/images/landing/layout-6d2x.jpg 2x" alt="DashLite Dashboard"></div>
                                    <div class="intro-preview-name">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/demo7/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-success"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/layout-7d.jpg'); ?>" srcset="/images/landing/layout-7d2x.jpg 2x" alt="DashLite Dashboard"></div>
                                    <div class="intro-preview-name">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/demo8/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-cyan"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/layout-8d.jpg'); ?>" srcset="/images/landing/layout-8d2x.jpg 2x" alt="DashLite Dashboard"></div>
                                    <div class="intro-preview-name">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="https://dashlite.net/landing/index.html" class="intro-preview-item" target="_blank">
                                    <div class="intro-preview-img bg-light"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/main-landing.jpg'); ?>" srcset="/images/landing/main-landing2x.jpg 2x" alt="DashLite Landing Page"></div>
                                    <div class="intro-preview-name">
                                    ...
                                    <div class="intro-team">
                                        ...
                                        <div class="intro-team-list">
                                            <div class="intro-team-member">
                                                <div class="intro-team-media"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/team-abu.jpg'); ?>" srcset="/images/landing/team-abu2x.jpg 2x" alt="Abu"></div>
                                            ...
                                            <div class="intro-team-member">
                                                <div class="intro-team-media"><img src="<?php echo base_url('assets/images/Dashlite-Examples/landing/team-nio.jpg'); ?>" srcset="/images/landing/team-nio2x.jpg 2x" alt="Nio"></div>
                                                <div class="intro-team-info">
