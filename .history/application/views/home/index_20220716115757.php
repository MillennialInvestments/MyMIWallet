                    ...
                    <div class="intro-banner-inner text-center">
                        <div class="intro-banner-desc">
                            ...
                            <p class="text-light">
                                ...
                                <strong class="text-white">MyMI Wallet</strong> comes with all kind of components, necessary elements and pre-build pages including exclusive <strong class="text-primary">Asset Marketplace & Exchanges</strong> that helps you to create your <a href="">Digital Assets</a> to sell to intereseted investors.</p>
                        </div>
