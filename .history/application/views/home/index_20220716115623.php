                ...
                <div class="intro-banner-wrap">
                    <div class="intro-banner-inner text-center">
                        <div class="intro-banner-desc">
                            ...
                            <p class="text-light">A powerful Investment Accountadmin dashboard template that especially build for developers and programmers. <strong class="text-white">DashLite</strong> comes with all kind of components, necessary elements and pre-build pages including exclusive <strong class="text-primary">conceptual apps screen</strong> that helps you to create your web apps or application faster.</p>
                        </div>
