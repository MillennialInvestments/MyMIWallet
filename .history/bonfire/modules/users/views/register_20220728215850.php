            ...
            <div class="col-lg-9 col-xl-7">
                <div class="intro-section-title text-center">
                    ...
                    <div class="intro-section-desc">
                        <p>
                            Register your <?php echo $registerType; ?> Account to join our Community of Investors and Partners, while enjoying the benefits of our Investment Accounting/Analyt
                        </p>
                    </div>
                </div>
            </div>
