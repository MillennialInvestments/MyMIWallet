                        ...
                        <div class="col-12 py-5">
                            <div class="nk-block-head nk-block-head-lg wide">
                                <div class="nk-block-head-content">
                                    ...
                                    <h3 class="nk-block-title fw-normal"><?php echo lang('us_reset_password'); ?></h3>
                                            ...
                                            <?php echo form_open($this->uri->uri_string(), array('class' => "form-horizontal", 'autocomplete' => 'off')); ?>
                                                <div class="<?php echo $formGroup; ?> <?php echo iif(form_error('email'), 'error'); ?>">
                                                    ...
                                                    <div class="<?php echo $formConCol; ?>">
                                                        <input class="<?php echo $form" type="text" name="email" id="email" value="<?php echo set_value('email') ?>" />
                                                    </div>
                                                </div>
