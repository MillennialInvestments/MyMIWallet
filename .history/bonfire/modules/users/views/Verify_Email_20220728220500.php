            ...
            <div class="col-lg-9 col-xl-7">
                <div class="intro-section-title text-center">
                    ...
                    <div class="intro-section-desc">
                        <p>
                            Verify your email address to activat <?php echo $registerType; ?> Account to join our Community of Investors and Partners, while enjoying the benefits of our Investment Accounting/Analytical Software and Crypto Asset Marketplace & Exchange.
                        </p>
                    </div>
                </div>
            </div>
