    ...
    constructor(data, legend = false) {
        ...
        this.d_saveChanges = async () => {
            try {
                ...
                //Async save changes
                let link        = debug?"http://localhost/MyMIWallet/v7/v1.5/public/index.php/Trade-Tracker/Trade-Manager" : "http://192.168.0/MyMIWallet/v7/v1.5/public/index.php/Trade-Tracker/Trade-Manager" : "https://www.mymiwallet.com/Trade-Tracker/Trade-Manager"
