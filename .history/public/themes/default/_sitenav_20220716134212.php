...
if ($beta === 0) {
    $registrationURL    = '/Free/register'; 
} elseif ($beta === 1) {
    $registrationURL    = '/Beta/register'; 
}
?>
        ...
        <div class="intro-wrap">
            ...
            <div class="intro-nav">
                ...
                <div class="intro-action">
                    <a href="<?php echo site_url($registrationURL); ?>" class="btn btn-primary" target="_blank">
                        <span class="d-none d-md-block">Register Now</span>
                    </a>
                </div>
            </div>
        </div>
