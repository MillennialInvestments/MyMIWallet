        ...
        <div class="intro-wrap">
            <div class="intro-logo d-flex w-50">
                <a href="<?php echo site_url('/'); ?>" class="logo-link w-100">
                    <img class="logo-img logo-light img-fluid d-none d-sm-block" src="<?php echo base_url('assets/images/Millennial-Investments.png'); ?>" srcset="<?php echo base_url('assets/images/My.png'); ?>" alt="MyMI Wallet - Investment Accounting/Analytical Software & Crypto Asset Marketplace/Exchange">
