        ...
        <div class="intro-wrap">
            <div class="intro-logo d-flex w-50">
                <a href="<?php echo site_url('/'); ?>" class="logo-link w-100">
                    ...
                    <img class="logo-img logo-dark img-fluid d-block d-sm-n" src="<?php echo base_url('assets/images/Millennial-Investments.png'); ?>" srcset="<?php echo base_url('assets/images/Millennial-Investments.png'); ?>" alt="MyMI Wallet - Investment Accounting/Analytical Software & Crypto Asset Marketplace/Exchange">
                </a>
            </div>
