        ...
        <div class="intro-wrap">
            <div class="intro-logo d-flex w-50">
                <a href="<?php echo site_url('/'); ?>" class="logo-link w-100">
                    ...
                    <img class="logo-img logo-dark img-fluid d-block d-sm-none" src="<?php echo base_url('assets/images/MyMI-Wallet.png'); ?>" srcset="<?php echo base_url('assets/images/MyMI-Wallets.png'); ?>" alt="MyMI Wallet - Investment Accounting/Analytical Software & Crypto Asset Marketplace/Exchange">
                    <img class="logo-img logo-dark img-fluid d-block d-sm-none" src="<?php echo base_url('assets/images/MyMI-Wallets.png'); ?>" srcset="<?php echo base_url('assets/images/MyMI-Wallets.png'); ?>" alt="MyMI Wallet - Investment Accounting/Analytical Software & Crypto Asset Marketplace/Exchange">
                </a>
            </div>
