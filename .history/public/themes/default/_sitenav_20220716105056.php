        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand">
                <a href="<?php echo site_url('/'); ?>" class="logo-link">
                    <img class="logo-light logo-img" src="<?php echo base_url('assets/images/Millennial-Investments.png'); ?>" srcset="<?php echo base_url('assets/images/Millennial-Investments.png'); ?>" alt="logo">
                    <img class="logo-dark logo-img" src="<?php echo base_url('assets/images/Millennial-Investments.png'); ?>" srcset="<?php echo base_url('assets/images/Millennial-Investments.png'); ?>" alt="logo-dark">
                </a>
            </div><!-- .nk-header-brand -->
            <div class="nk-header-menu" data-content="headerNav">
                <div class="nk-header-mobile">
                    <div class="nk-header-brand">
                        <a href="<?php echo site_url('/'); ?>" class="logo-link">
                            <img class="logo-light logo-img" src="<?php echo base_url('assets/images/Millennial-Investments.png'); ?>" srcset="./images/logo2x.png 2x" alt="logo">
                            <img class="logo-dark logo-img" src="<?php echo base_url('assets/images/Millennial-Investments.png'); ?>" srcset="./images/logo-dark2x.png 2x" alt="logo-dark">
                        </a>
                    </div>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a href="<?php echo site_url('/'); ?>" class="nk-menu-link">
