            ...
            <div class="intro-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item intro-nav-item d-none d-lg-inline-flex">
                        <a href="https://themeforest.net/user/softnio#contact" target="_blank" class="nav-link intro-nav-link">Need Help?</a>
                    </li>
                </ul>
                <div class="intro-action">
                    <a href="https://1.envato.market/e0y3g" class="btn btn-primary" target="_blank"><span class="d-none d-md-block">Purchase Now</span><em class="d-md-none icon ni ni-dashlite"></em></a></div>
            </div>
        </div>
    </div>
</div>