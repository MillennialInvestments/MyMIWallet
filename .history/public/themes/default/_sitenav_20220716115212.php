...
<div class="intro-navbar">
    <div class="container container-ld">
        <div class="intro-wrap">
            <div class="intro-logo"><a href="./" class="logo-link"><img class="logo-img logo-light" src="<?php ec/images/logo.png" srcset="/images/logo2x.png 2x" alt="DashLite Template"><img class="logo-img logo-dark" src="/images/logo-dark.png" srcset="/images/logo-dark2x.png 2x" alt="DashLite Template"></a></div>
            <div class="intro-nav">
                <ul class="nav">
