        ...
        <div class="intro-wrap">
            <div class="intro-logo">
                <a href="<?php echo site_url('/'); ?>" class="logo-link">
                    ...
                    <img class="logo-img logo-dark" src="/images/logo-dark.png" srcset="/images/logo-dark2x.png 2x" alt="MyMI Wallet - Investment Accounting/Analytical Software & Crypto Asset Marketplace/Exchange">
                </a>
            </div>
            <div class="intro-nav">
                <ul class="nav">
