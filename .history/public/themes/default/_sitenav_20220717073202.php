        ...
        <div class="intro-wrap">
            <div class="intro-logo">
                <a href="<?php echo site_url('/'); ?>" class="logo-link">
                    <img class="logo-img logo-light" s src="<?php echo base_url('assets/images/Millennial-Investments.png'); ?>" srcset="<?php echo base_url('assets/images/Millennial-Investments.png'); ?>" alt="MyMI Wallet - Investment Accounting/Analytical Software & Crypto Asset Marketplace/Exchange">
