...
if ($pageType === 'Standard') {
    ...
    $page_title 			= $pageURIB . ' Release - ' . $pageURIC . ' | MyMI Wallet | The Future of Investments';
    $page_description 		= 'View more details and in-depth information regar our most recent ' . $pageURIC . ' Beta Release at MyMI Wallet';
    $page_url 				= $pageInfo['page_url'];
    $page_sitemap_url 		= $pageInfo['page_sitemap_url'];
    $page_image 			= $pageInfo['page_image'];
    echo
