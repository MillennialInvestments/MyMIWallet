			...
			<div class="nk-header-brand d-xl-none">
				<a href="<?php echo site_url('/Dashboard'); ?>" class="logo-link">
                    ...
                    if ($this->agent->is_mobile()) {
                        echo '
						<img class="logo-light logo-img d-lg-block" src="' . base_url('Millennial-Investments-The-Best-In-Investments-Logo-Only-White-BG.png') . '" srcset="' . base_url('aMillennial-Investments-The-Best-In-Investments-Logo-Only-White-BG.png') . '" alt="logo" />
